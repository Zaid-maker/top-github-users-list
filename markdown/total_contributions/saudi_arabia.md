...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2024/6/14 8:17 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
