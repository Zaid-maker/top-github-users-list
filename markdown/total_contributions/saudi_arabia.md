...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2024/8/6 3:19 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
