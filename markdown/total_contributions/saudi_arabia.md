...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2025/1/30 2:18 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
