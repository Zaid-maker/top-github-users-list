...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2023/5/10 9:14 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
