...
The `public contributions` and `private contributions` by users in Russia on `2024/5/16 9:17 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>675</td>
		<td>
			<a href="https://github.com/PreaawX">
