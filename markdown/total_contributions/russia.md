...
The `public contributions` and `private contributions` by users in Russia on `2024/7/2 2:37 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>263</td>
		<td>
			<a href="https://github.com/hexqueller">
	...
	<tr>
		<td>509</td>
		<td>
			<a href="https://github.com/magna-z">
	...
	<tr>
		<td>539</td>
		<td>
			<a href="https://github.com/andrewpetrochenkov">
