...
The `public contributions` and `private contributions` by users in Russia on `2024/1/10 12:23 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `972 users`  in Russia. You need at least `52 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>30</td>
		<td>
			<a href="https://github.com/DmitryChitalov">
	...
	<tr>
		...
		<td>+79653442462 </td>
		<td>No Twitter Username</td>
		<td>Laniakea, Sol biota incubator, Supracaucasus, Moscow, Strawberry Duck, 30\3.</td>
		<td>30</td>
		<td>33</td>
	</tr>
	<tr>
	...
	<tr>
		<td>600</td>
		<td>
			<a href="https://github.com/zbx-sadman">
