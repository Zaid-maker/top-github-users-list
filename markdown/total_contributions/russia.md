...
The `public contributions` and `private contributions` by users in Russia on `2024/1/16 6:19 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/antontuzov">
				<img src="https://avatars.githubusercontent.com/u/12977048?s=72&u=74e7496b4fbbae6bc8c86e1f11f554602446c905&v=4" width="24" alt="Avatar of antontuzov"> antontuzov
			</a><br/>
			Anton Tuzov
		</td>
		<td>No Company</td>
