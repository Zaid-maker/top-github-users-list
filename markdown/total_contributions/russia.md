...
The `public contributions` and `private contributions` by users in Russia on `2024/6/8 10:15 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>268</td>
		<td>
			<a href="https://github.com/ndyjan1337">
