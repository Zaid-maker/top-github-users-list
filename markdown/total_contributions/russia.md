...
The `public contributions` and `private contributions` by users in Russia on `2024/2/8 6:19 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>193</td>
		<td>
			<a href="https://github.com/curryrasul">
		...
		<td><a href="https://twitter.com/curryrasul">curryrasul</a></td>
		<td>Russia, Moscow</td>
		<td>490</td>
		<td>524</td>
	</tr>
	...
	<tr>
		...
		<td>Kaimi.io </td>
		<td><a href="https://twitter.com/kaimi_io">kaimi_io</a></td>
		<td>Russia</td>
		<td>36</td>
		<td>36</td>
	</tr>
