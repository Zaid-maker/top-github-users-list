...
The `public contributions` and `private contributions` by users in Russia on `2024/2/2 12:21 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>828</td>
		<td>
			<a href="https://github.com/hulkiedo17">
