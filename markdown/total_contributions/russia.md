...
The `public contributions` and `private contributions` by users in Russia on `2024/4/29 3:17 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>443</td>
		<td>
			<a href="https://github.com/ruslavn">
	...
	<tr>
		<td>662</td>
		<td>
			<a href="https://github.com/kshvakov">
