...
The `public contributions` and `private contributions` by users in Russia on `2024/5/28 9:17 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		...
		<td>+79653442462 </td>
		<td><a href="https://twitter.com/cyber_bio_sec">cyber_bio_sec</a></td>
	...
	<tr>
		<td>474</td>
		<td>
			<a href="https://github.com/rusIand">
