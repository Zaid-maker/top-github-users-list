...
The `public contributions` and `private contributions` by users in Russia on `2024/7/7 9:17 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>572</td>
		<td>
			<a href="https://github.com/aleksandr-kotlyar">
