...
The `public contributions` and `private contributions` by users in Nigeria on `2024/7/24 6:22 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
