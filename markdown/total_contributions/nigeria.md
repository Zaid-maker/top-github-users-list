...
The `public contributions` and `private contributions` by users in Nigeria on `2025/8/20 6:29 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
