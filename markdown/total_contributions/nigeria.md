...
The `public contributions` and `private contributions` by users in Nigeria on `2025/4/5 11:22 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
