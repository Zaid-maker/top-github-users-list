...
The `public contributions` and `private contributions` by users in Nigeria on `2024/10/27 10:20 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
