...
The `public contributions` and `private contributions` by users in Nigeria on `2025/5/12 8:28 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
