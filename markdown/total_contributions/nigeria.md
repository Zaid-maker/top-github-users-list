...
The `public contributions` and `private contributions` by users in Nigeria on `2024/6/8 9:19 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
