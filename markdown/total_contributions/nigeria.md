...
The `public contributions` and `private contributions` by users in Nigeria on `2024/8/17 8:21 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
