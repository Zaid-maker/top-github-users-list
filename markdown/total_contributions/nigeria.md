...
The `public contributions` and `private contributions` by users in Nigeria on `2023/4/17 2:07 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
