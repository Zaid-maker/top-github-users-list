...
The `public contributions` and `private contributions` by users in Nigeria on `2024/7/18 10:16 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
