...
The `public contributions` and `private contributions` by users in Nigeria on `2024/5/22 2:31 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
