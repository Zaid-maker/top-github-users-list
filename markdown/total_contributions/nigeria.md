...
The `public contributions` and `private contributions` by users in Nigeria on `2023/1/5 1:26 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
