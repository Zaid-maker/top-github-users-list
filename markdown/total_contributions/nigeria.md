...
The `public contributions` and `private contributions` by users in Nigeria on `2023/5/4 10:16 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
