...
The `public contributions` and `private contributions` by users in Slovenia on `2022/12/31 3:18 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
