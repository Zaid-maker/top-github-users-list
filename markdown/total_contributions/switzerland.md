...
The `public contributions` and `private contributions` by users in Switzerland on `2024/8/30 12:28 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
