...
The `public contributions` and `private contributions` by users in Switzerland on `2022/12/31 10:14 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
