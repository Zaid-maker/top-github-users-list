...
The `public contributions` and `private contributions` by users in Switzerland on `2023/5/17 9:15 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
