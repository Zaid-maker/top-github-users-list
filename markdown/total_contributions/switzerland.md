...
The `public contributions` and `private contributions` by users in Switzerland on `2023/3/31 9:14 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
