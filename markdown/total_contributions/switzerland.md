...
The `public contributions` and `private contributions` by users in Switzerland on `2023/4/29 9:13 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
