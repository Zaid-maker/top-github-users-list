...
The `public contributions` and `private contributions` by users in Sudan on `2023/12/19 1:58 AM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/josephakaro">josephakaro</a></td>
		<td>Juba, South Sudan</td>
		<td>962</td>
		<td>962</td>
	</tr>
