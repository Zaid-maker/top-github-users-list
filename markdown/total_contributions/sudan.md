...
The `public contributions` and `private contributions` by users in Sudan on `2025/2/24 5:19 AM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/osmanapdo">
				<img src="https://avatars.githubusercontent.com/u/114744848?s=72&v=4" width="24" alt="Avatar of osmanapdo"> osmanapdo
			</a><br/>
			Osman Abdualzeem
		</td>
		<td>Sudasemi </td>
