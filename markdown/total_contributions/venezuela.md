...
The `public contributions` and `private contributions` by users in Venezuela on `2023/2/18 11:14 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
