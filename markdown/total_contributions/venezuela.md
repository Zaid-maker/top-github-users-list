...
The `public contributions` and `private contributions` by users in Venezuela on `2023/4/13 12:41 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
