...
The `public contributions` and `private contributions` by users in Venezuela on `2024/1/11 5:15 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
