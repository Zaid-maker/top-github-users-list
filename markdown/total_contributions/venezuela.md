...
The `public contributions` and `private contributions` by users in Venezuela on `2024/5/12 8:18 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
