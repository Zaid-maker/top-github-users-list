...
The `public contributions` and `private contributions` by users in Venezuela on `2024/1/28 11:16 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
