...
The `public contributions` and `private contributions` by users in Venezuela on `2023/12/31 4:17 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
