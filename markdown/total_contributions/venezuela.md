...
The `public contributions` and `private contributions` by users in Venezuela on `2023/3/14 12:25 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
