...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/1/20 12:22 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
