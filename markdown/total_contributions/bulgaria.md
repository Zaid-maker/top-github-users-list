...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/3/27 9:24 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/piterjb">
				<img src="https://avatars.githubusercontent.com/u/33602245?s=72&u=c281e092be2f0d886d1ba7f90e8250d808c59d4e&v=4" width="24" alt="Avatar of piterjb"> piterjb
			</a><br/>
			ZhelezoCode
		</td>
		<td>Individual  </td>
