...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/2/1 8:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
...
<table>
	...
	<tr>
		...
		<td>Kodisi Ltd., Red Hat<br/>Inc.<br/></td>
