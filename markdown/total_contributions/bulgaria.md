...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/8/17 3:30 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
...
<table>
	...
	<tr>
		...
		<td>Insait, Sofia University |<br/>Thu<br/>|<br/>Zjut<br/></td>
