...
The `public contributions` and `private contributions` by users in Bulgaria on `2024/7/21 6:19 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
...
<table>
	...
	<tr>
		...
		<td>Test </td>
		<td><a href="https://twitter.com/Ally251251">Ally251251</a></td>
		<td>Sofia</td>
		<td>2</td>
		<td>3</td>
	</tr>
