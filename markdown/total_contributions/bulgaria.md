...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/1/14 12:21 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
