...
The `public contributions` and `private contributions` by users in Bulgaria on `2024/3/16 3:17 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/icom85">
				<img src="https://avatars.githubusercontent.com/u/5156494?s=72&u=59f0c60a2756020f297d55a390c295b5831647ea&v=4" width="24" alt="Avatar of icom85"> icom85
			</a><br/>
			Hristo Merdjanov
		</td>
		<td>@telerik  </td>
