...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/4/25 5:14 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
