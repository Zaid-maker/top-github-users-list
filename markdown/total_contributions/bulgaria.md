...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/5/9 5:22 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Ivshti">
				<img src="https://avatars.githubusercontent.com/u/1247629?s=72&u=2e97c5416c582abf7e43d0dedbe342050fce21f3&v=4" width="24" alt="Avatar of Ivshti"> Ivshti
			</a><br/>
			Ivo Georgiev
		</td>
		<td>@ambiretech </td>
