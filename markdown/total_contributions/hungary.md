...
The `public contributions` and `private contributions` by users in Hungary on `2022/12/26 5:15 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
