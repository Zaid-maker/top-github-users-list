...
The `public contributions` and `private contributions` by users in Palestine on `2024/12/15 6:25 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
