...
The `public contributions` and `private contributions` by users in Palestine on `2025/2/4 5:19 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
