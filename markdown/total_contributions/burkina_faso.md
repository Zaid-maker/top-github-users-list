...
The `public contributions` and `private contributions` by users in Burkina Faso on `2024/1/7 12:46 AM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
