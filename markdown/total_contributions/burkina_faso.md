...
The `public contributions` and `private contributions` by users in Burkina Faso on `2024/6/17 2:00 AM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
