...
The `public contributions` and `private contributions` by users in Malta on `2023/1/22 10:13 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
