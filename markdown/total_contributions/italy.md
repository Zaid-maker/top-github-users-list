...
The `public contributions` and `private contributions` by users in Italy on `2023/1/4 5:12 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
