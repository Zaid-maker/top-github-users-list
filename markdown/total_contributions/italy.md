...
The `public contributions` and `private contributions` by users in Italy on `2025/6/23 10:25 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
