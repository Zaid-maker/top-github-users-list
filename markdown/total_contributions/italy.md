...
The `public contributions` and `private contributions` by users in Italy on `2023/4/4 4:16 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
