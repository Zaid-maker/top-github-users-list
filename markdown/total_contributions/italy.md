...
The `public contributions` and `private contributions` by users in Italy on `2023/2/21 7:16 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
