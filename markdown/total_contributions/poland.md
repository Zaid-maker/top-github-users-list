...
The `public contributions` and `private contributions` by users in Poland on `2025/5/12 5:22 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
