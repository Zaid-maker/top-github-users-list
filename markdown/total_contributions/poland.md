...
The `public contributions` and `private contributions` by users in Poland on `2023/1/17 11:12 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
