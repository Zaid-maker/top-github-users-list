...
The `public contributions` and `private contributions` by users in Poland on `2023/2/16 11:17 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
