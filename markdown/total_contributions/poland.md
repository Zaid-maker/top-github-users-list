...
The `public contributions` and `private contributions` by users in Poland on `2023/3/1 12:53 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
