...
The `public contributions` and `private contributions` by users in Poland on `2025/7/1 1:40 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
