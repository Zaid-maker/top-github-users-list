...
The `public contributions` and `private contributions` by users in Poland on `2022/12/30 1:16 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
