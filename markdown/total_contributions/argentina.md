...
The `public contributions` and `private contributions` by users in Argentina on `2023/1/25 8:16 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Lucaturgueniev">Lucaturgueniev</a></td>
		<td>Argentina </td>
		<td>123</td>
		<td>185</td>
	</tr>
	...
	<tr>
		...
		<td>@transumption </td>
		<td><a href="https://twitter.com/yanalunaterra">yanalunaterra</a></td>
		<td>Buenos Aires, Argentina</td>
		<td>65</td>
		<td>126</td>
	</tr>
