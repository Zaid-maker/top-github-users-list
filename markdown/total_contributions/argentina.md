...
The `public contributions` and `private contributions` by users in Argentina on `2023/1/7 8:17 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tamaraantonella">
				<img src="https://avatars.githubusercontent.com/u/103323518?s=72&u=b89bcdca050d01806a10558975327015f4a45a3a&v=4" width="24" alt="Avatar of tamaraantonella"> tamaraantonella
			</a><br/>
			Tamara 
		</td>
		<td>Cityheroes </td>
