...
The `public contributions` and `private contributions` by users in Rwanda on `2024/2/8 7:17 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/SergeInGithub">
				<img src="https://avatars.githubusercontent.com/u/110470861?s=72&u=beda0a0101eb7175100aa55db3bcc14e7b15719d&v=4" width="24" alt="Avatar of SergeInGithub"> SergeInGithub
			</a><br/>
			Serge M. NYIRIGIRA
		</td>
		<td>No Company</td>
