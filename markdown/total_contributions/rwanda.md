...
The `public contributions` and `private contributions` by users in Rwanda on `2024/2/19 7:15 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
...
<table>
	...
	<tr>
		...
		<td>No Twitter Username</td>
		<td>Congo-Kinshasa, Kigali Rwanda</td>
		<td>62</td>
		<td>1401</td>
	</tr>
	<tr>
