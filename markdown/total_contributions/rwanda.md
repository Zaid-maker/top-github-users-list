...
The `public contributions` and `private contributions` by users in Rwanda on `2025/4/12 2:22 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `962 users`  in Rwanda. You need at least `8 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/adamlogman">
				<img src="https://avatars.githubusercontent.com/u/97489757?s=72&u=d2fd63debd5dd7e3aabed4990b1b46b8706e8dea&v=4" width="24" alt="Avatar of adamlogman"> adamlogman
			</a><br/>
			Adam Logman
		</td>
		<td>No Company</td>
