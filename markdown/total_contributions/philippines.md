...
The `public contributions` and `private contributions` by users in Philippines on `2024/1/16 2:00 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
