...
The `public contributions` and `private contributions` by users in Philippines on `2023/4/29 12:42 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
