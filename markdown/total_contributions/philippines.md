...
The `public contributions` and `private contributions` by users in Philippines on `2023/12/29 6:18 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
