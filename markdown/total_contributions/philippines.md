...
The `public contributions` and `private contributions` by users in Philippines on `2024/4/23 4:19 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
