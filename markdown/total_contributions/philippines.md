...
The `public contributions` and `private contributions` by users in Philippines on `2023/4/17 9:16 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
