...
The `public contributions` and `private contributions` by users in Philippines on `2023/5/22 8:17 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
