...
The `public contributions` and `private contributions` by users in Philippines on `2024/8/29 2:20 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
