...
The `public contributions` and `private contributions` by users in Philippines on `2025/1/15 6:25 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
