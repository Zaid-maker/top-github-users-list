...
The `public contributions` and `private contributions` by users in Namibia on `2024/8/11 5:15 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		<td>184</td>
		<td>
			<a href="https://github.com/Ephedian">
				<img src="https://avatars.githubusercontent.com/u/178050997?s=72&v=4" width="24" alt="Avatar of Ephedian"> Ephedian
			</a><br/>
			Adrien Khustell 
		</td>
		<td>Ephedian Bank </td>
