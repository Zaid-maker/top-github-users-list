...
The `public contributions` and `private contributions` by users in Namibia on `2024/9/21 9:15 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		<td>193</td>
		<td>
			<a href="https://github.com/Michael99-mk">
				<img src="https://avatars.githubusercontent.com/u/86631270?s=72&v=4" width="24" alt="Avatar of Michael99-mk"> Michael99-mk
			</a><br/>
			Michael
		</td>
		<td>Mre </td>
