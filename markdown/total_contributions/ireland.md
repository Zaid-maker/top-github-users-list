...
The `public contributions` and `private contributions` by users in Ireland on `2024/1/8 1:20 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/darkershell">
				<img src="https://avatars.githubusercontent.com/u/45039331?s=72&u=6009547b4bd9cec8ee04a44c4cd007e06ba21a12&v=4" width="24" alt="Avatar of darkershell"> darkershell
			</a><br/>
			Richard Nixon
		</td>
