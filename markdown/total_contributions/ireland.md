...
The `public contributions` and `private contributions` by users in Ireland on `2024/11/7 12:30 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/testableapple">
				<img src="https://avatars.githubusercontent.com/u/20794991?s=72&u=07acf29affdf3ee4354a5ad16baf1ba23ccd6047&v=4" width="24" alt="Avatar of testableapple"> testableapple
			</a><br/>
