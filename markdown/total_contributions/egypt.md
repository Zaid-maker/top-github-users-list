...
The `public contributions` and `private contributions` by users in Egypt on `2025/1/6 6:27 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
