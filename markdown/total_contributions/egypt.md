...
The `public contributions` and `private contributions` by users in Egypt on `2024/12/31 2:24 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
