...
The `public contributions` and `private contributions` by users in Egypt on `2023/12/27 7:16 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
