...
The `public contributions` and `private contributions` by users in Maldives on `2022/12/27 4:12 PM UTC`. This list contains users from `Maldives` and cities `Malé` `Addu-city`.
