...
The `public contributions` and `private contributions` by users in China on `2025/7/23 8:30 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `934 users`  in China. You need at least `784 followers` to be on this list.
