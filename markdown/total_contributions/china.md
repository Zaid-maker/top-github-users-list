...
The `public contributions` and `private contributions` by users in China on `2025/3/28 6:26 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/rootsongjc">
				<img src="https://avatars.githubusercontent.com/u/3328185?s=72&u=7cbd1612e14d5ccb04cec2b9f104dde93a4afb18&v=4" width="24" alt="Avatar of rootsongjc"> rootsongjc
			</a><br/>
			Jimmy Song
		</td>
		<td>@tetrateio </td>
