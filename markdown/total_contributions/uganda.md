...
The `public contributions` and `private contributions` by users in Uganda on `2023/2/12 3:19 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
