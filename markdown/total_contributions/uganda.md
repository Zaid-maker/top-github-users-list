...
The `public contributions` and `private contributions` by users in Uganda on `2023/12/30 9:14 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
