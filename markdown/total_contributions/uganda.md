...
The `public contributions` and `private contributions` by users in Uganda on `2023/4/6 11:15 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
