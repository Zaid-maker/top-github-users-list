...
The `public contributions` and `private contributions` by users in Uganda on `2024/4/30 1:17 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
