...
The `public contributions` and `private contributions` by users in Uganda on `2023/2/24 4:17 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
