...
The `public contributions` and `private contributions` by users in Uganda on `2023/2/18 3:15 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
