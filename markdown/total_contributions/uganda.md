...
The `public contributions` and `private contributions` by users in Uganda on `2023/4/18 12:22 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
