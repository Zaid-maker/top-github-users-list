...
The `public contributions` and `private contributions` by users in Uganda on `2022/12/31 4:16 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
