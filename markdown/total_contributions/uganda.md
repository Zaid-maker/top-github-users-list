...
The `public contributions` and `private contributions` by users in Uganda on `2025/1/30 9:22 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
