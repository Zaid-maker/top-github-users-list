...
The `public contributions` and `private contributions` by users in Uganda on `2023/5/11 4:16 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
