...
The `public contributions` and `private contributions` by users in Uganda on `2025/4/13 2:19 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
