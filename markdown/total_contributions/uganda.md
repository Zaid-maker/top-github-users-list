...
The `public contributions` and `private contributions` by users in Uganda on `2023/3/20 5:15 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
