...
The `public contributions` and `private contributions` by users in Uganda on `2024/4/12 2:16 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
