...
The `public contributions` and `private contributions` by users in Turkey on `2023/4/6 10:14 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
