...
The `public contributions` and `private contributions` by users in Turkey on `2024/6/27 3:18 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
