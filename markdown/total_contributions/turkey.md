...
The `public contributions` and `private contributions` by users in Turkey on `2024/3/20 12:22 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
