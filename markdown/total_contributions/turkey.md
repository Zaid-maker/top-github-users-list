...
The `public contributions` and `private contributions` by users in Turkey on `2022/12/31 3:15 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
