...
The `public contributions` and `private contributions` by users in Ghana on `2023/3/16 7:14 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
