...
The `public contributions` and `private contributions` by users in Ghana on `2025/1/13 9:23 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
