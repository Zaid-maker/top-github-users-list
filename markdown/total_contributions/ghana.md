...
The `public contributions` and `private contributions` by users in Ghana on `2023/2/2 5:15 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/Process85902140">Process85902140</a></td>
		<td>Ghana </td>
		<td>37</td>
		<td>37</td>
	</tr>
