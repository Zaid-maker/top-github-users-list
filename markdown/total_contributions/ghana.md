...
The `public contributions` and `private contributions` by users in Ghana on `2025/3/17 4:24 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			Henry Addo(Unemployed; looking for work)
		</td>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/othnielonx">othnielonx</a></td>
		<td>Accra</td>
		<td>2</td>
		<td>497</td>
	</tr>
