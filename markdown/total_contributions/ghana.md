...
The `public contributions` and `private contributions` by users in Ghana on `2024/11/1 3:37 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `985 users`  in Ghana. You need at least `18 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/thealiceiris">
				<img src="https://avatars.githubusercontent.com/u/92753379?s=72&u=aa626fbd8a04f51a6cb409b9c7ecdb8bb4aa2ebf&v=4" width="24" alt="Avatar of thealiceiris"> thealiceiris
			</a><br/>
