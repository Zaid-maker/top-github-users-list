...
The `public contributions` and `private contributions` by users in Ghana on `2023/4/15 5:14 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
