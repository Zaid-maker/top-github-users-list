...
The `public contributions` and `private contributions` by users in Ghana on `2023/5/8 10:15 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
