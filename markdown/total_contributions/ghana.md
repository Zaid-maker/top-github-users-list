...
The `public contributions` and `private contributions` by users in Ghana on `2025/5/16 2:22 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/roqkabel">
				<img src="https://avatars.githubusercontent.com/u/44670648?s=72&u=57c5b52ab904c3c384063d301762c25ed3123c46&v=4" width="24" alt="Avatar of roqkabel"> roqkabel
			</a><br/>
			Obed Asante
		</td>
		<td>@purplewave </td>
