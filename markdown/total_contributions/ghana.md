...
The `public contributions` and `private contributions` by users in Ghana on `2024/4/3 2:16 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
