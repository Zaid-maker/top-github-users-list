...
The `public contributions` and `private contributions` by users in South Africa on `2025/7/14 4:26 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fatalbanana">
				<img src="https://avatars.githubusercontent.com/u/2176651?s=72&v=4" width="24" alt="Avatar of fatalbanana"> fatalbanana
			</a><br/>
			Andrew Lewis
		</td>
		<td>No Company</td>
