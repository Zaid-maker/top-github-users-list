...
The `public contributions` and `private contributions` by users in Lithuania on `2024/4/16 4:20 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
