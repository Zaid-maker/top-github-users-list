...
The `public contributions` and `private contributions` by users in Lithuania on `2024/8/28 7:19 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
