...
The `public contributions` and `private contributions` by users in Lithuania on `2025/4/29 6:28 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
