...
The `public contributions` and `private contributions` by users in Lithuania on `2025/6/30 4:39 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
