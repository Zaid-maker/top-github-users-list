...
The `public contributions` and `private contributions` by users in Lithuania on `2023/3/17 5:15 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
