...
The `public contributions` and `private contributions` by users in Lithuania on `2024/2/12 1:16 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
