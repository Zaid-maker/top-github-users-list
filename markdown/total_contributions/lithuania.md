...
The `public contributions` and `private contributions` by users in Lithuania on `2023/4/4 2:16 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
