...
The `public contributions` and `private contributions` by users in Lithuania on `2024/8/16 11:18 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
