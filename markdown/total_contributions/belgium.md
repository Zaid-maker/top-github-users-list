...
The `public contributions` and `private contributions` by users in Belgium on `2023/3/15 7:15 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
