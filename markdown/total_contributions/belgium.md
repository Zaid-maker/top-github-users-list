...
The `public contributions` and `private contributions` by users in Belgium on `2022/12/24 11:17 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
