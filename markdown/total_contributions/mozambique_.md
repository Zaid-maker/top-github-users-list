...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/1/11 7:13 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		<td>569</td>
		<td>
			<a href="https://github.com/derickniteki">
				<img src="https://avatars.githubusercontent.com/u/110594009?s=72&v=4" width="24" alt="Avatar of derickniteki"> derickniteki
			</a><br/>
			Niteki
		</td>
