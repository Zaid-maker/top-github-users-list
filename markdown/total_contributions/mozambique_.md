...
The `public contributions` and `private contributions` by users in Mozambique  on `2025/4/23 8:21 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		<td>406</td>
		<td>
			<a href="https://github.com/NzManuel">
				<img src="https://avatars.githubusercontent.com/u/205363487?s=72&v=4" width="24" alt="Avatar of NzManuel"> NzManuel
			</a><br/>
			Manuel Ndlhaze
		</td>
		<td>Mects </td>
