...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/5/9 10:12 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Mozambique, matola, machava km 15</td>
		<td>3</td>
		<td>3</td>
	</tr>
	<tr>
