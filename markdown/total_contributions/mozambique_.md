...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/2/4 7:13 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
