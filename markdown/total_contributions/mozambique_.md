...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/1/23 7:14 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
