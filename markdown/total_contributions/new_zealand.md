...
The `public contributions` and `private contributions` by users in New Zealand on `2023/5/10 3:15 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
