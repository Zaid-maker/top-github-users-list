...
The `public contributions` and `private contributions` by users in New Zealand on `2023/5/4 8:17 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
