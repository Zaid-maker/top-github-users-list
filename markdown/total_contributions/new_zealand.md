...
The `public contributions` and `private contributions` by users in New Zealand on `2023/1/5 11:18 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
