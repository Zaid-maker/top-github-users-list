...
The `public contributions` and `private contributions` by users in New Zealand on `2022/12/29 8:18 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
