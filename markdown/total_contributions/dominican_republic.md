...
The `public contributions` and `private contributions` by users in Dominican Republic on `2024/4/15 9:14 AM UTC`. This list contains users from `Dominican Republic` and cities `Santo-domingo` `Puerto-plata` `San-pedro-de-macoris` `Santiago-de-los-caballeros` `Higuey`.
