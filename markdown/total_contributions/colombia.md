...
The `public contributions` and `private contributions` by users in Colombia on `2023/1/14 11:16 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
