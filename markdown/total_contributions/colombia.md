...
The `public contributions` and `private contributions` by users in Colombia on `2024/5/13 8:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
