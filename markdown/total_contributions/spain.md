...
The `public contributions` and `private contributions` by users in Spain on `2024/1/16 6:19 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
