...
The `public contributions` and `private contributions` by users in Spain on `2024/2/14 12:23 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
