...
The `public contributions` and `private contributions` by users in Spain on `2024/9/11 7:20 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
