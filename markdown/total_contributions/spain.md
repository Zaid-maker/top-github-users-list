...
The `public contributions` and `private contributions` by users in Spain on `2024/10/29 1:04 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
