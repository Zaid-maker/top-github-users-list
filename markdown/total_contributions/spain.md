...
The `public contributions` and `private contributions` by users in Spain on `2025/1/3 10:23 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
