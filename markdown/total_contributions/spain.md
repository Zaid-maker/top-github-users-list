...
The `public contributions` and `private contributions` by users in Spain on `2024/10/23 2:24 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
