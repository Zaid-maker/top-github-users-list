...
The `public contributions` and `private contributions` by users in Spain on `2023/1/12 4:35 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
