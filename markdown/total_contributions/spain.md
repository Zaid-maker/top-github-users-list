...
The `public contributions` and `private contributions` by users in Spain on `2024/9/5 7:20 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
