...
The `public contributions` and `private contributions` by users in Spain on `2023/5/17 5:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
