...
The `public contributions` and `private contributions` by users in Spain on `2024/7/2 2:18 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
