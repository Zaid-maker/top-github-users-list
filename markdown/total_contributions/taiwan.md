...
The `public contributions` and `private contributions` by users in Taiwan on `2023/2/1 10:15 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
