...
The `public contributions` and `private contributions` by users in Taiwan on `2024/5/13 7:15 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
