...
The `public contributions` and `private contributions` by users in Taiwan on `2023/4/8 5:13 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
