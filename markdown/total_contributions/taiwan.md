...
The `public contributions` and `private contributions` by users in Taiwan on `2024/4/8 2:16 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
