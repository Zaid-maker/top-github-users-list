...
The `public contributions` and `private contributions` by users in Taiwan on `2024/9/7 1:21 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
