...
The `public contributions` and `private contributions` by users in Taiwan on `2023/5/25 7:15 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
