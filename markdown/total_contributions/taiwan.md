...
The `public contributions` and `private contributions` by users in Taiwan on `2024/5/8 1:37 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
