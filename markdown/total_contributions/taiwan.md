...
The `public contributions` and `private contributions` by users in Taiwan on `2023/12/26 9:15 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
