...
The `public contributions` and `private contributions` by users in Taiwan on `2023/4/2 9:13 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
