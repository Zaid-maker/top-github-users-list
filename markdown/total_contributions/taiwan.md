...
The `public contributions` and `private contributions` by users in Taiwan on `2023/4/14 11:14 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
