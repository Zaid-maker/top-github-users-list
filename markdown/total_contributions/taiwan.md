...
The `public contributions` and `private contributions` by users in Taiwan on `2025/1/12 2:19 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
