...
The `public contributions` and `private contributions` by users in Taiwan on `2023/3/4 2:21 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
