...
The `public contributions` and `private contributions` by users in Taiwan on `2023/1/8 10:16 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
