...
The `public contributions` and `private contributions` by users in Taiwan on `2023/5/1 9:14 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
