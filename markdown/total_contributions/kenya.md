...
The `public contributions` and `private contributions` by users in Kenya on `2025/4/10 8:23 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
