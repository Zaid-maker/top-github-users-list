...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/9/6 6:23 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jailanaseel">
				<img src="https://avatars.githubusercontent.com/u/154667300?s=72&v=4" width="24" alt="Avatar of jailanaseel"> jailanaseel
			</a><br/>
			iamjailan
		</td>
		<td>Aseel </td>
	...
	<tr>
		...
		<td>Alhawa Group Of Companies<br/><br/></td>
		<td>No Twitter Username</td>
		<td>Kabul Afghanistan </td>
		<td>34</td>
		<td>34</td>
