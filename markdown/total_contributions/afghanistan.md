...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/10/24 1:00 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `901 users`  in Afghanistan. You need at least `1 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ZubairCoding">
				<img src="https://avatars.githubusercontent.com/u/144668224?s=72&u=80fd196e7d7b0a232b516169737fd4199ff099be&v=4" width="24" alt="Avatar of ZubairCoding"> ZubairCoding
			</a><br/>
			ZubairAlko
		</td>
		<td>Self </td>
