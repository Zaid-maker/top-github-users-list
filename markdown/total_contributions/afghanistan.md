...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/10/18 2:22 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `902 users`  in Afghanistan. You need at least `1 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/amini21766">
				<img src="https://avatars.githubusercontent.com/u/152692612?s=72&v=4" width="24" alt="Avatar of amini21766"> amini21766
			</a><br/>
			Hamid Ahmad Amini
		</td>
		<td>No Company</td>
