...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/4/1 1:15 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Auxkabel1337">
				<img src="https://avatars.githubusercontent.com/u/115661100?s=72&u=cf4d0f451df94223da71b7656464d236c05d474f&v=4" width="24" alt="Avatar of Auxkabel1337"> Auxkabel1337
			</a><br/>
			Auxkabel
		</td>
		<td>Auxkabel </td>
