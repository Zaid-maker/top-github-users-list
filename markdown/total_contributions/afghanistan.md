...
The `public contributions` and `private contributions` by users in Afghanistan on `2025/1/11 6:22 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Mazar-i-sharif` `Jalalabad` `Kunduz` `Ghazni` `Lashkar Gah` `Sheberghan` `Taloqan`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MahsumaRezai">
				<img src="https://avatars.githubusercontent.com/u/110189253?s=72&u=7e4e858deb9ae8e067cde41888a9ef8b199e6ca5&v=4" width="24" alt="Avatar of MahsumaRezai"> MahsumaRezai
			</a><br/>
			Masoumeh Rezai
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>Afghanistan Holding Group </td>
		<td>No Twitter Username</td>
		<td>Kabul, Afghanistan</td>
		<td>15</td>
		<td>15</td>
