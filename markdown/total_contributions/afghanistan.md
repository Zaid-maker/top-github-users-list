...
The `public contributions` and `private contributions` by users in Afghanistan on `2025/4/2 2:32 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Mazar-i-sharif` `Jalalabad` `Kunduz` `Ghazni` `Lashkar Gah` `Sheberghan` `Taloqan`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `912 users`  in Afghanistan. You need at least `1 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/NasarAhmadSadid20">
				<img src="https://avatars.githubusercontent.com/u/200037833?s=72&u=7be12c1235db0488229a0173ffb877f6b2250eea&v=4" width="24" alt="Avatar of NasarAhmadSadid20"> NasarAhmadSadid20
			</a><br/>
			Nasar Ahmad Sadid
		</td>
		<td>No Company</td>
