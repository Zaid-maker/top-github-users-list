...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/1/6 3:15 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jailanaseel">
				<img src="https://avatars.githubusercontent.com/u/154667300?s=72&u=b251d496ed329c4dcdbbf0ff12244f560d42aed0&v=4" width="24" alt="Avatar of jailanaseel"> jailanaseel
			</a><br/>
			Jailan Mirkhel
		</td>
		<td>Aseel </td>
