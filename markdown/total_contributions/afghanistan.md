...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/11/4 11:19 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `906 users`  in Afghanistan. You need at least `1 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>494</td>
		<td>
			<a href="https://github.com/Bilal-zahirzai">
				<img src="https://avatars.githubusercontent.com/u/119731593?s=72&u=a5cb2328f592216fa9899f6508df0b528bd02302&v=4" width="24" alt="Avatar of Bilal-zahirzai"> Bilal-zahirzai
			</a><br/>
			Bilal
		</td>
		<td>No Company</td>
