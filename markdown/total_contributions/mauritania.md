...
The `public contributions` and `private contributions` by users in Mauritania on `2024/6/19 9:13 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
