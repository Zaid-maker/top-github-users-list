...
The `public contributions` and `private contributions` by users in Mauritania on `2023/2/3 11:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
