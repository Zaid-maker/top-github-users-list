...
The `public contributions` and `private contributions` by users in Mauritania on `2023/5/3 8:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
