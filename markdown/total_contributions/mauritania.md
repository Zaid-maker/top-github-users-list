...
The `public contributions` and `private contributions` by users in Mauritania on `2023/4/28 2:34 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
