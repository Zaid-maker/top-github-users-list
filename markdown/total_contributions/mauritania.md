...
The `public contributions` and `private contributions` by users in Mauritania on `2024/1/20 9:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
