...
The `public contributions` and `private contributions` by users in Mauritania on `2024/10/27 8:16 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
