...
The `public contributions` and `private contributions` by users in Mauritania on `2023/2/15 11:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
