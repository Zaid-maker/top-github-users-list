...
The `public contributions` and `private contributions` by users in Canada on `2023/1/14 5:10 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `139 users`  in Canada. You need at least `828 followers` to be on this list.
