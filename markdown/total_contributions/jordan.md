...
The `public contributions` and `private contributions` by users in Jordan on `2023/1/16 9:16 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
