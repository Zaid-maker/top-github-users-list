...
The `public contributions` and `private contributions` by users in Jordan on `2023/12/22 12:22 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
