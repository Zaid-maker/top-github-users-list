...
The `public contributions` and `private contributions` by users in Jordan on `2022/12/27 5:14 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
