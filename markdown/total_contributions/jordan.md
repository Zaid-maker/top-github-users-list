...
The `public contributions` and `private contributions` by users in Jordan on `2023/4/15 8:14 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
