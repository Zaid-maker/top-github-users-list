...
The `public contributions` and `private contributions` by users in Jordan on `2024/5/3 4:18 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
