...
The `public contributions` and `private contributions` by users in Greece on `2023/2/14 6:18 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
