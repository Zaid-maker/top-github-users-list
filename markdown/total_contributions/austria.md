...
The `public contributions` and `private contributions` by users in Austria on `2025/4/26 1:31 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `879 users`  in Austria. You need at least `54 followers` to be on this list.
