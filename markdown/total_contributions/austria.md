...
The `public contributions` and `private contributions` by users in Austria on `2025/8/22 3:23 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `938 users`  in Austria. You need at least `53 followers` to be on this list.
