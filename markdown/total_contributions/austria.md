...
The `public contributions` and `private contributions` by users in Austria on `2024/12/17 11:22 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `909 users`  in Austria. You need at least `49 followers` to be on this list.
