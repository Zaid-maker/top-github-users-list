...
The `public contributions` and `private contributions` by users in Austria on `2025/5/20 10:21 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/retrooper">
				<img src="https://avatars.githubusercontent.com/u/49798017?s=72&u=fd8e53918d3cea035cc3d9588fc9cd2718d8f575&v=4" width="24" alt="Avatar of retrooper"> retrooper
			</a><br/>
			retrooper
		</td>
		<td>No Company</td>
