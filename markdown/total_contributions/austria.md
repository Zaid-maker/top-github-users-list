...
The `public contributions` and `private contributions` by users in Austria on `2025/8/28 5:21 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `937 users`  in Austria. You need at least `53 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MANU-de">
				<img src="https://avatars.githubusercontent.com/u/67684505?s=72&u=ce8693c114a5e05e786a9f06774994b78b248676&v=4" width="24" alt="Avatar of MANU-de"> MANU-de
			</a><br/>
