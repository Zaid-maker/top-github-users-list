...
The `public contributions` and `private contributions` by users in Austria on `2025/5/8 4:26 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `945 users`  in Austria. You need at least `51 followers` to be on this list.
