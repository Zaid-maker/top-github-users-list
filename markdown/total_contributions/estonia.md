...
The `public contributions` and `private contributions` by users in Estonia on `2023/5/8 4:14 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
