...
The `public contributions` and `private contributions` by users in Estonia on `2023/12/27 9:13 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
