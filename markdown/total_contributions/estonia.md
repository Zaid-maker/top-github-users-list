...
The `public contributions` and `private contributions` by users in Estonia on `2023/12/21 3:13 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/SashaMihhailov">
				<img src="https://avatars.githubusercontent.com/u/344435?s=72&u=7f7c9dc9001594d896f1b9aa6014faa056bffef8&v=4" width="24" alt="Avatar of SashaMihhailov"> SashaMihhailov
			</a><br/>
			Sasha Mihhailov
		</td>
		<td>Starship Technologies </td>
