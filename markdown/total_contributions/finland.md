...
The `public contributions` and `private contributions` by users in Finland on `2025/6/10 4:31 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
