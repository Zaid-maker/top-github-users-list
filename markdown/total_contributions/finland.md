...
The `public contributions` and `private contributions` by users in Finland on `2023/3/28 1:24 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
