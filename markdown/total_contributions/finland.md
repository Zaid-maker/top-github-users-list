...
The `public contributions` and `private contributions` by users in Finland on `2025/8/18 5:28 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
