...
The `public contributions` and `private contributions` by users in Finland on `2025/4/28 4:26 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
