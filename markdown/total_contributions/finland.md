...
The `public contributions` and `private contributions` by users in Finland on `2023/1/9 1:29 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
