...
The `public contributions` and `private contributions` by users in Finland on `2023/5/2 11:13 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
