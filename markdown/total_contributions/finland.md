...
The `public contributions` and `private contributions` by users in Finland on `2024/7/28 2:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
