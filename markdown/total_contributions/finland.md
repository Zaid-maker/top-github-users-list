...
The `public contributions` and `private contributions` by users in Finland on `2025/1/20 3:25 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
