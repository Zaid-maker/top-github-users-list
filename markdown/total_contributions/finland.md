...
The `public contributions` and `private contributions` by users in Finland on `2024/9/20 3:23 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
