...
The `public contributions` and `private contributions` by users in Finland on `2023/4/20 9:14 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
