...
The `public contributions` and `private contributions` by users in Finland on `2024/5/8 3:17 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
