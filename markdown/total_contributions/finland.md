...
The `public contributions` and `private contributions` by users in Finland on `2023/4/3 11:14 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
