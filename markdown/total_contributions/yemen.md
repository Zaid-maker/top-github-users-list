...
The `public contributions` and `private contributions` by users in Yemen on `2024/12/16 11:20 PM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Farea-YCC">
				<img src="https://avatars.githubusercontent.com/u/127134204?s=72&v=4" width="24" alt="Avatar of Farea-YCC"> Farea-YCC
			</a><br/>
			Farea AL-Dhela'a
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>
			...
			ABDULLAH ABDULRAHMAN ABDULLAH AL-AGHBARI
		</td>
		<td>@osx_software </td>
