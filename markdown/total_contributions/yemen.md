...
The `public contributions` and `private contributions` by users in Yemen on `2024/9/18 2:15 AM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/omamkaz">
				<img src="https://avatars.githubusercontent.com/u/57198110?s=72&v=4" width="24" alt="Avatar of omamkaz"> omamkaz
			</a><br/>
