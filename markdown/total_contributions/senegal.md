...
The `public contributions` and `private contributions` by users in Senegal on `2023/3/13 11:12 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.
