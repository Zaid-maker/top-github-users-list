...
The `public contributions` and `private contributions` by users in Senegal on `2023/3/7 11:14 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.
