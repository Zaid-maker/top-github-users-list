...
The `public contributions` and `private contributions` by users in Senegal on `2023/4/17 6:15 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
