...
The `public contributions` and `private contributions` by users in Senegal on `2022/12/30 9:12 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
