...
The `public contributions` and `private contributions` by users in Senegal on `2023/2/17 8:17 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.
