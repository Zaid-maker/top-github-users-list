...
The `public contributions` and `private contributions` by users in Myanmar on `2024/10/15 6:23 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DevShinnThant">
				<img src="https://avatars.githubusercontent.com/u/94442302?s=72&u=c6fe41b0b529e51bc43a6e72fcf11d2f32774f48&v=4" width="24" alt="Avatar of DevShinnThant"> DevShinnThant
			</a><br/>
			Shinn Thant
		</td>
		<td>Farytaxi </td>
