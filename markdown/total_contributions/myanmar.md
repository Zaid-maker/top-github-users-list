...
The `public contributions` and `private contributions` by users in Myanmar on `2024/8/17 2:40 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/aunghtetnay">
				<img src="https://avatars.githubusercontent.com/u/57069407?s=72&u=dd3a288b6b241d3ef4e20a58ede98f563703181d&v=4" width="24" alt="Avatar of aunghtetnay"> aunghtetnay
			</a><br/>
			Aung Htet Nay
		</td>
		<td>Binary_lab </td>
