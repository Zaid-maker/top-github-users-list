...
The `public contributions` and `private contributions` by users in Armenia on `2023/2/12 9:13 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
