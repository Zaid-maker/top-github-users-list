...
The `public contributions` and `private contributions` by users in Ukraine on `2025/3/8 1:23 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
