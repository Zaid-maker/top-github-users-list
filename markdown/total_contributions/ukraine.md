...
The `public contributions` and `private contributions` by users in Ukraine on `2023/5/23 1:18 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
