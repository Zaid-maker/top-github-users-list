...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/7 1:33 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
...
<table>
	...
	<tr>
		<td>359</td>
		<td>
			<a href="https://github.com/tsarenkotxt">
	...
	<tr>
		<td>468</td>
		<td>
			<a href="https://github.com/astakhiv">
