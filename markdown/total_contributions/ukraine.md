...
The `public contributions` and `private contributions` by users in Ukraine on `2025/6/1 11:19 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
