...
The `public contributions` and `private contributions` by users in Ukraine on `2023/5/5 10:14 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
