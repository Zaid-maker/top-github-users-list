...
The `public contributions` and `private contributions` by users in Ukraine on `2023/4/1 4:16 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
