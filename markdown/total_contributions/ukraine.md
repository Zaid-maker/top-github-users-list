...
The `public contributions` and `private contributions` by users in Ukraine on `2023/4/18 1:21 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
