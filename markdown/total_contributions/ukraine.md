...
The `public contributions` and `private contributions` by users in Ukraine on `2023/2/18 5:15 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
