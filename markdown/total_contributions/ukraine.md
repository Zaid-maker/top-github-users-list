...
The `public contributions` and `private contributions` by users in Ukraine on `2023/5/17 4:17 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
