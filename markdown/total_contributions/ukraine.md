...
The `public contributions` and `private contributions` by users in Ukraine on `2024/1/22 11:17 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
