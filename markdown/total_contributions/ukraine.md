...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/1 2:22 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
