...
The `public contributions` and `private contributions` by users in Ukraine on `2024/6/15 4:20 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
