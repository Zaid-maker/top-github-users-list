...
The `public contributions` and `private contributions` by users in Ukraine on `2023/4/12 6:17 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
