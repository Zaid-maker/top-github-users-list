...
The `public contributions` and `private contributions` by users in Ukraine on `2023/2/12 4:17 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
