...
The `public contributions` and `private contributions` by users in Ukraine on `2025/3/14 12:33 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
