...
The `public contributions` and `private contributions` by users in Uruguay on `2024/1/5 8:17 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/vincentes">
				<img src="https://avatars.githubusercontent.com/u/11695552?s=72&u=ed9757bf09f49b55204a8ae6bb1a29feabba6e42&v=4" width="24" alt="Avatar of vincentes"> vincentes
			</a><br/>
			Vicente Bermúdez
		</td>
		<td>No Company</td>
