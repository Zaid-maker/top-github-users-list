...
The `public contributions` and `private contributions` by users in Uruguay on `2024/8/7 4:22 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `960 users`  in Uruguay. You need at least `8 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Co-founder & Cto At<br/>Mubent<br/>|<br/>Backend<br/>Developer<br/>At<br/>Dbsoft<br/>Co<br/></td>
		<td>No Twitter Username</td>
		<td>Uruguay</td>
		<td>1</td>
		<td>256</td>
