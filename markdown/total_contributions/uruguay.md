...
The `public contributions` and `private contributions` by users in Uruguay on `2024/1/17 9:18 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/vincentes">
				<img src="https://avatars.githubusercontent.com/u/11695552?s=72&u=abc8f9fb37013c0ced8ebf4343c7128d2fda07f3&v=4" width="24" alt="Avatar of vincentes"> vincentes
			</a><br/>
			Vicente Bermúdez
		</td>
		<td>No Company</td>
