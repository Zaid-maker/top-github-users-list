...
The `public contributions` and `private contributions` by users in Uruguay on `2023/12/25 8:19 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/camilavinik">
				<img src="https://avatars.githubusercontent.com/u/73668147?s=72&u=6d1aea7f5ffb18032a366e0ca7699de1b785df7a&v=4" width="24" alt="Avatar of camilavinik"> camilavinik
			</a><br/>
			Camila
		</td>
		<td>Upshow </td>
