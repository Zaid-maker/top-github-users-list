...
The `public contributions` and `private contributions` by users in Uruguay on `2023/2/6 8:19 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/grazianobolla">
				<img src="https://avatars.githubusercontent.com/u/35064738?s=72&u=50b2ed6cee79085ed4fd2edd7ca92746b340166d&v=4" width="24" alt="Avatar of grazianobolla"> grazianobolla
			</a><br/>
			Graziano Bolla
		</td>
		<td>No Company</td>
