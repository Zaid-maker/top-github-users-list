...
The `public contributions` and `private contributions` by users in Uruguay on `2024/4/19 6:20 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `961 users`  in Uruguay. You need at least `8 followers` to be on this list.
