...
The `public contributions` and `private contributions` by users in Nepal on `2025/1/2 2:22 AM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
...
<table>
	...
	<tr>
		<td>857</td>
		<td>
			<a href="https://github.com/ansghimire">
				<img src="https://avatars.githubusercontent.com/u/47380538?s=72&v=4" width="24" alt="Avatar of ansghimire"> ansghimire
			</a><br/>
			Anish Ghimire
		</td>
		<td>Not Yet Worked In<br/>Company<br/></td>
		<td><a href="https://twitter.com/anish25280459">anish25280459</a></td>
		<td>Chitwan, Nepal</td>
		<td>4</td>
		<td>8</td>
	</tr>
