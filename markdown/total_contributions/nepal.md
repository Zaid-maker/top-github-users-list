...
The `public contributions` and `private contributions` by users in Nepal on `2025/4/30 1:09 AM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bimalagadtaula">
				<img src="https://avatars.githubusercontent.com/u/51883592?s=72&u=6fc9b1336d299f9b5bd3433d8d404a09d9f968dd&v=4" width="24" alt="Avatar of bimalagadtaula"> bimalagadtaula
			</a><br/>
			Bimala Gadtaula
		</td>
		<td>No Company</td>
