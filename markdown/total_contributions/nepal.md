...
The `public contributions` and `private contributions` by users in Nepal on `2025/2/4 8:25 AM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bimalagadtaula">
				<img src="https://avatars.githubusercontent.com/u/51883592?s=72&v=4" width="24" alt="Avatar of bimalagadtaula"> bimalagadtaula
			</a><br/>
			Bimala Gadtaula
		</td>
		<td>No Company</td>
