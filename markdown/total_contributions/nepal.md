...
The `public contributions` and `private contributions` by users in Nepal on `2025/7/19 5:23 PM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
...
<table>
	...
	<tr>
		<td>643</td>
		<td>
			<a href="https://github.com/khojwar">
				<img src="https://avatars.githubusercontent.com/u/66153890?s=72&v=4" width="24" alt="Avatar of khojwar"> khojwar
			</a><br/>
			Tika Ram Khojwar
		</td>
		<td>No Company</td>
