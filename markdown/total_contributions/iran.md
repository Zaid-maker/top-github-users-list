...
The `public contributions` and `private contributions` by users in Iran on `2023/1/10 2:23 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
