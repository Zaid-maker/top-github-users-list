...
The `public contributions` and `private contributions` by users in Iran on `2024/12/13 1:31 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
