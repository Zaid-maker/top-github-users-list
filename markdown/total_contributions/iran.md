...
The `public contributions` and `private contributions` by users in Iran on `2023/5/8 6:15 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
