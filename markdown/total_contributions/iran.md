...
The `public contributions` and `private contributions` by users in Iran on `2023/4/3 11:13 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
