...
The `public contributions` and `private contributions` by users in Iran on `2022/12/26 9:13 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
