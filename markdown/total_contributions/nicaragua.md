...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/3/6 11:21 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>244</td>
		<td>
			<a href="https://github.com/Edwing123">
				<img src="https://avatars.githubusercontent.com/u/40911825?s=72&u=0a87837aec80ac6f118496823f731fb93e2b63e0&v=4" width="24" alt="Avatar of Edwing123"> Edwing123
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
