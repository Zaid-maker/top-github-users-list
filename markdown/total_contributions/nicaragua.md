...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/5/30 7:18 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Cerv1">
				<img src="https://avatars.githubusercontent.com/u/11405177?s=72&u=fd06cfaf44b7e0185dda046ebd5226a136f94cdf&v=4" width="24" alt="Avatar of Cerv1"> Cerv1
			</a><br/>
			Cervi
		</td>
		<td>No Company</td>
