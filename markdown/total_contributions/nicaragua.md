...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/1/15 8:24 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alexxandraSalazar">
				<img src="https://avatars.githubusercontent.com/u/138623509?s=72&u=205dd2c50444f32ee0702a1b7ef2c14dbed092ba&v=4" width="24" alt="Avatar of alexxandraSalazar"> alexxandraSalazar
			</a><br/>
			Alexandra Salazar
		</td>
		<td>No Company</td>
