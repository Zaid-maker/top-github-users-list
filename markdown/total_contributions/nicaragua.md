...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/10/4 2:21 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>451</td>
		<td>
			<a href="https://github.com/erickGit-dev">
				<img src="https://avatars.githubusercontent.com/u/130728494?s=72&u=0cdd7182986ba7056d3c40cc0cc75e042dcd49d9&v=4" width="24" alt="Avatar of erickGit-dev"> erickGit-dev
			</a><br/>
			Erick Salgado
		</td>
		<td>No Company</td>
