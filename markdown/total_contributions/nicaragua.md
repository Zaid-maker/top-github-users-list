...
The `public contributions` and `private contributions` by users in Nicaragua on `2023/12/29 9:15 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
