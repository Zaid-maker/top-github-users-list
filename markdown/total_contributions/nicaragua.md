...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/6/24 6:26 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/0xlaguna">
				<img src="https://avatars.githubusercontent.com/u/29028444?s=72&u=ea37778b7dd22f2345ced7909a8293ccf3477ab4&v=4" width="24" alt="Avatar of 0xlaguna"> 0xlaguna
			</a><br/>
			Maykol Laguna
		</td>
		<td>No Company</td>
