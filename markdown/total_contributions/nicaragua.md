...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/1/15 4:18 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/willR30">
				<img src="https://avatars.githubusercontent.com/u/50780601?s=72&u=5aef7944e7c004d19192f347d9808ac9f6ac098c&v=4" width="24" alt="Avatar of willR30"> willR30
			</a><br/>
			William Cáceres
		</td>
		<td>No Company</td>
