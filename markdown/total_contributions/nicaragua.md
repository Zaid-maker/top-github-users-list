...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/5/10 1:17 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
