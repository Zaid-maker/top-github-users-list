...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/1/8 2:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alexxandraSalazar">
				<img src="https://avatars.githubusercontent.com/u/138623509?s=72&u=b84e07891c2fa62b9c462f70975601c47a837ed5&v=4" width="24" alt="Avatar of alexxandraSalazar"> alexxandraSalazar
			</a><br/>
			Alexandra Salazar
		</td>
		<td>No Company</td>
