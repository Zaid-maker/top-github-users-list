...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/7/13 1:32 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/DuckInsane_X47">DuckInsane_X47</a></td>
