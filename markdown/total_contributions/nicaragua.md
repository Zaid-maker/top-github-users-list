...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/7/1 12:26 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DavidGDA">
				<img src="https://avatars.githubusercontent.com/u/138391657?s=72&v=4" width="24" alt="Avatar of DavidGDA"> DavidGDA
			</a><br/>
			DavidGDA
		</td>
		<td>No Company</td>
