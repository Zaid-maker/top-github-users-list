...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/6/5 11:22 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
