...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/3/18 10:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>392</td>
		<td>
			<a href="https://github.com/Dalex19">
				<img src="https://avatars.githubusercontent.com/u/50632756?s=72&u=d97a6011d736ddbbbc764b9d277f1f7142354ec9&v=4" width="24" alt="Avatar of Dalex19"> Dalex19
			</a><br/>
			Alex FC
		</td>
		<td>No Company</td>
