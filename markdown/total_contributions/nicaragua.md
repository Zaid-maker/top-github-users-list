...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/11/20 9:19 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>330</td>
		<td>
			<a href="https://github.com/jasminavalos">
				<img src="https://avatars.githubusercontent.com/u/135176093?s=72&u=7bdaed20da5b4a9b02d5252a682b47e6a22d16fb&v=4" width="24" alt="Avatar of jasminavalos"> jasminavalos
			</a><br/>
			Jasmin Avalos
		</td>
		<td>No Company</td>
