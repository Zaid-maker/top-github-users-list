...
The `public contributions` and `private contributions` by users in Nicaragua on `2025/6/18 12:35 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ai-zac">
				<img src="https://avatars.githubusercontent.com/u/79810500?s=72&u=d5ede0708993fc04775a857c76f3eda1f119bbb1&v=4" width="24" alt="Avatar of ai-zac"> ai-zac
			</a><br/>
			isaac
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>Universidad Nacional De Educación<br/>A<br/>Distancia,<br/>Student<br/></td>
		<td>No Twitter Username</td>
