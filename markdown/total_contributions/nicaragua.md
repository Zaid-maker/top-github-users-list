...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/10/27 9:19 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>27</td>
		<td>
			<a href="https://github.com/alexandraXsalazar">
				<img src="https://avatars.githubusercontent.com/u/138623509?s=72&u=e1662ce10c47bf274957813dfaa3d6e08e1610a5&v=4" width="24" alt="Avatar of alexandraXsalazar"> alexandraXsalazar
			</a><br/>
			Alexandra Salazar
		</td>
		<td>No Company</td>
