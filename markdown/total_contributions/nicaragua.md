...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/12/8 11:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		<td>388</td>
		<td>
			<a href="https://github.com/manidmt">
				<img src="https://avatars.githubusercontent.com/u/78505061?s=72&u=43b1848579ca5f31292d47f98140df4a579bfb97&v=4" width="24" alt="Avatar of manidmt"> manidmt
			</a><br/>
			Manuel
		</td>
		<td>Ugr </td>
