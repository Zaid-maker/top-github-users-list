...
The `public contributions` and `private contributions` by users in Botswana on `2023/12/20 3:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>249</td>
		<td>
			<a href="https://github.com/swathamen">
				<img src="https://avatars.githubusercontent.com/u/154398934?s=72&v=4" width="24" alt="Avatar of swathamen"> swathamen
			</a><br/>
			Stacee
		</td>
		<td>No Company</td>
