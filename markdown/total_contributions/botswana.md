...
The `public contributions` and `private contributions` by users in Botswana on `2023/1/2 9:11 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
