...
The `public contributions` and `private contributions` by users in Botswana on `2023/5/12 10:11 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>180</td>
		<td>
			<a href="https://github.com/Cyberbiso">
				<img src="https://avatars.githubusercontent.com/u/132594495?s=72&v=4" width="24" alt="Avatar of Cyberbiso"> Cyberbiso
			</a><br/>
			Thabiso Seleke
		</td>
		<td>No Company</td>
