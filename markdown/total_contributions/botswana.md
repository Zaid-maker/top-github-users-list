...
The `public contributions` and `private contributions` by users in Botswana on `2023/4/25 3:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
