...
The `public contributions` and `private contributions` by users in Norway on `2024/4/11 4:21 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
