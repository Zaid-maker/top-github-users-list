...
The `public contributions` and `private contributions` by users in Norway on `2023/1/11 3:21 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
