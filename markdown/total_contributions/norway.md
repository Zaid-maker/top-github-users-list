...
The `public contributions` and `private contributions` by users in Norway on `2023/2/22 4:20 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
