...
The `public contributions` and `private contributions` by users in Norway on `2024/5/22 3:21 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
