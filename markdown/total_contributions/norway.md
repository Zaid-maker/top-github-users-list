...
The `public contributions` and `private contributions` by users in Norway on `2023/4/22 9:13 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
