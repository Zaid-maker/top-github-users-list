...
The `public contributions` and `private contributions` by users in Norway on `2024/7/18 11:19 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
