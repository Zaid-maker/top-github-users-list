...
The `public contributions` and `private contributions` by users in Norway on `2024/4/17 3:19 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
