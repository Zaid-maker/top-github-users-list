...
The `public contributions` and `private contributions` by users in Norway on `2023/3/6 6:20 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
