...
The `public contributions` and `private contributions` by users in Norway on `2023/5/16 3:18 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
