...
The `public contributions` and `private contributions` by users in Norway on `2023/12/29 11:16 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
