...
The `public contributions` and `private contributions` by users in Norway on `2022/12/29 11:17 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
