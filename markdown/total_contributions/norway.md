...
The `public contributions` and `private contributions` by users in Norway on `2023/1/23 3:18 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
