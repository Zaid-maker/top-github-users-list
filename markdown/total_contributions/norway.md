...
The `public contributions` and `private contributions` by users in Norway on `2023/5/10 6:19 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
