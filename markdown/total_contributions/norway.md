...
The `public contributions` and `private contributions` by users in Norway on `2024/12/9 2:48 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
