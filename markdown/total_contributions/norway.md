...
The `public contributions` and `private contributions` by users in Norway on `2024/11/2 11:23 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
