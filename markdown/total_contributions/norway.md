...
The `public contributions` and `private contributions` by users in Norway on `2024/1/10 12:49 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
