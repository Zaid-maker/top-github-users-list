...
The `public contributions` and `private contributions` by users in Malawi on `2024/12/8 5:20 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/skipper_116">skipper_116</a></td>
		<td>Malawi</td>
		<td>888</td>
		<td>2496</td>
	</tr>
