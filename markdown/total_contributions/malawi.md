...
The `public contributions` and `private contributions` by users in Malawi on `2024/4/10 8:18 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Sydney83">
				<img src="https://avatars.githubusercontent.com/u/18641851?s=72&v=4" width="24" alt="Avatar of Sydney83"> Sydney83
			</a><br/>
			Sydney Nyirenda
		</td>
