...
The `public contributions` and `private contributions` by users in Malawi on `2024/6/30 5:14 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/destin55">
				<img src="https://avatars.githubusercontent.com/u/68310069?s=72&v=4" width="24" alt="Avatar of destin55"> destin55
			</a><br/>
			Dennis Reuben
		</td>
		<td>Uy Scuti  </td>
