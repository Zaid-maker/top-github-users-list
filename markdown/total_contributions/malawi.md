...
The `public contributions` and `private contributions` by users in Malawi on `2022/12/27 2:12 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		...
		<td>@freelancing </td>
		<td><a href="https://twitter.com/francis_amidu">francis_amidu</a></td>
		<td>Malawi</td>
		<td>205</td>
		<td>205</td>
	</tr>
