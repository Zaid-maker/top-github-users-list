...
The `public contributions` and `private contributions` by users in Georgia on `2023/2/2 3:15 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
