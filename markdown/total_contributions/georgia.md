...
The `public contributions` and `private contributions` by users in Georgia on `2023/5/2 1:18 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
