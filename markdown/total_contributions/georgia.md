...
The `public contributions` and `private contributions` by users in Georgia on `2024/10/20 2:30 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
