...
The `public contributions` and `private contributions` by users in Georgia on `2025/1/13 7:22 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
