...
The `public contributions` and `private contributions` by users in Georgia on `2024/1/8 2:00 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
