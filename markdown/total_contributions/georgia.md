...
The `public contributions` and `private contributions` by users in Georgia on `2023/1/21 3:14 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
