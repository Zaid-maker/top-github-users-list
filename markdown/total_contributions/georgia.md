...
The `public contributions` and `private contributions` by users in Georgia on `2023/5/14 3:14 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
