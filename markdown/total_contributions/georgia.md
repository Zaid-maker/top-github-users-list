...
The `public contributions` and `private contributions` by users in Georgia on `2025/5/10 8:23 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
