...
The `public contributions` and `private contributions` by users in Georgia on `2023/4/9 9:14 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
