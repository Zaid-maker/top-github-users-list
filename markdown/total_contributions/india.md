...
The `public contributions` and `private contributions` by users in India on `2024/9/2 3:19 PM UTC`. This list contains users from `India` and cities `Mumbai` `Bengaluru` `Chennai` `Ahmedabad` `Pune` `Kolkata` `Hyderabad` `New-delhi` `Lucknow` `Jaipur`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tagda-coder">
				<img src="https://avatars.githubusercontent.com/u/83112278?s=72&u=99c7b17bb7fdd8498473eefeddd56bdc007a6f3d&v=4" width="24" alt="Avatar of tagda-coder"> tagda-coder
			</a><br/>
			         Mandeep Malakar 
		</td>
		<td>Tagda Coder  </td>
