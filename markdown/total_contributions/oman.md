...
The `public contributions` and `private contributions` by users in Oman on `2023/4/17 3:14 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
