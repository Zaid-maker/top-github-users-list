...
The `public contributions` and `private contributions` by users in Oman on `2022/12/30 12:43 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
