...
The `public contributions` and `private contributions` by users in Kuwait on `2023/4/4 11:12 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
