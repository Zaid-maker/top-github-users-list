...
The `public contributions` and `private contributions` by users in Kuwait on `2023/4/21 7:11 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
