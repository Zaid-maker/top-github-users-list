...
The `public contributions` and `private contributions` by users in Mali on `2024/6/30 8:12 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
