...
The `public contributions` and `private contributions` by users in Mali on `2023/5/9 1:35 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
