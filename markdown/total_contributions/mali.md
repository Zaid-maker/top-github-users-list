...
The `public contributions` and `private contributions` by users in Mali on `2023/1/4 8:10 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
