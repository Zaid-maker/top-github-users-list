...
The `public contributions` and `private contributions` by users in Mali on `2023/3/17 11:09 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
