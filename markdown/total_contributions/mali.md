...
The `public contributions` and `private contributions` by users in Mali on `2024/9/21 10:14 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
