...
The `public contributions` and `private contributions` by users in Mali on `2022/12/27 5:08 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
