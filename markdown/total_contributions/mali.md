...
The `public contributions` and `private contributions` by users in Mali on `2024/5/9 10:11 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
