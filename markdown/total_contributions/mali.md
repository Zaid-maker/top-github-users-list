...
The `public contributions` and `private contributions` by users in Mali on `2023/1/28 9:08 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
