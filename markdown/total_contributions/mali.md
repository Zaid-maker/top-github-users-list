...
The `public contributions` and `private contributions` by users in Mali on `2024/8/22 2:13 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
