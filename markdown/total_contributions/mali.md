...
The `public contributions` and `private contributions` by users in Mali on `2024/6/25 1:59 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
