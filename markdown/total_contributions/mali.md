...
The `public contributions` and `private contributions` by users in Mali on `2023/3/12 12:43 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
