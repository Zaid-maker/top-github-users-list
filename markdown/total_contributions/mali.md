...
The `public contributions` and `private contributions` by users in Mali on `2024/1/9 6:14 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
