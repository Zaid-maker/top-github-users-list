...
The `public contributions` and `private contributions` by users in Mali on `2024/4/4 5:10 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
