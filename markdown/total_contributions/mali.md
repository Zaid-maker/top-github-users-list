...
The `public contributions` and `private contributions` by users in Mali on `2023/12/28 6:13 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
