...
The `public contributions` and `private contributions` by users in Mali on `2024/8/28 1:20 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
