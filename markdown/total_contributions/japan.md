...
The `public contributions` and `private contributions` by users in Japan on `2023/1/16 8:16 AM UTC`. This list contains users from `Japan` and cities `Tokyo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `90 users`  in Japan. You need at least `905 followers` to be on this list.
