...
The `public contributions` and `private contributions` by users in Iraq on `2024/3/29 4:18 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
