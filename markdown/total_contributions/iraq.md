...
The `public contributions` and `private contributions` by users in Iraq on `2023/5/14 2:12 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
