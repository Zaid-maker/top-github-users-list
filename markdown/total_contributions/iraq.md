...
The `public contributions` and `private contributions` by users in Iraq on `2024/5/3 10:17 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
