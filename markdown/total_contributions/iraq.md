...
The `public contributions` and `private contributions` by users in Iraq on `2024/4/27 4:16 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
