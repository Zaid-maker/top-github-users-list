...
The `public contributions` and `private contributions` by users in Iraq on `2022/12/26 10:13 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
