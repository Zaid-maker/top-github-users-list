...
The `public contributions` and `private contributions` by users in Iraq on `2023/2/27 4:16 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
