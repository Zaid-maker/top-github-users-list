...
The `public contributions` and `private contributions` by users in Iraq on `2024/11/19 12:30 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
