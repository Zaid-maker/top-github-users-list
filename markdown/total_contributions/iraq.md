...
The `public contributions` and `private contributions` by users in Iraq on `2023/3/17 5:14 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
