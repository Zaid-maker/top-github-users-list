...
The `public contributions` and `private contributions` by users in Iraq on `2023/12/16 12:21 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
