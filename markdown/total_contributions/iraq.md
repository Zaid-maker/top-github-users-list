...
The `public contributions` and `private contributions` by users in Iraq on `2023/2/9 3:19 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
