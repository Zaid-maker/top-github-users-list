...
The `public contributions` and `private contributions` by users in Iraq on `2024/11/7 11:18 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
