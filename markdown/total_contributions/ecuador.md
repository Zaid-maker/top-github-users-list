...
The `public contributions` and `private contributions` by users in Ecuador on `2025/8/17 10:21 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
