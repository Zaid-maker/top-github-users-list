...
The `public contributions` and `private contributions` by users in Ecuador on `2024/12/6 6:25 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
