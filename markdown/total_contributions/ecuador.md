...
The `public contributions` and `private contributions` by users in Ecuador on `2024/3/28 10:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
