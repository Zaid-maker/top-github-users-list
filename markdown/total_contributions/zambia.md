...
The `public contributions` and `private contributions` by users in Zambia on `2025/4/7 11:19 PM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `876 users`  in Zambia. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Jeenyhus">
				<img src="https://avatars.githubusercontent.com/u/105205508?s=72&v=4" width="24" alt="Avatar of Jeenyhus"> Jeenyhus
			</a><br/>
			Dabwitso Mweemba
		</td>
		<td>Code Savanna </td>
