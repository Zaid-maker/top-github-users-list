...
The `public contributions` and `private contributions` by users in Tanzania on `2024/9/17 12:28 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
