...
The `public contributions` and `private contributions` by users in Tanzania on `2024/10/5 11:16 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
