...
The `public contributions` and `private contributions` by users in Tanzania on `2024/12/28 1:23 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
