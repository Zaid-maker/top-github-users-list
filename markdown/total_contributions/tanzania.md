...
The `public contributions` and `private contributions` by users in Tanzania on `2025/2/12 8:23 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
