...
The `public contributions` and `private contributions` by users in Tanzania on `2025/1/10 1:26 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
