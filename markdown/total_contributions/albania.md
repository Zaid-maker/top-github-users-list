...
The `public contributions` and `private contributions` by users in Albania on `2023/4/19 2:07 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
