...
The `public contributions` and `private contributions` by users in Albania on `2024/10/18 3:27 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
