...
The `public contributions` and `private contributions` by users in United States on `2023/4/12 9:15 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
