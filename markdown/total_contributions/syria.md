...
The `public contributions` and `private contributions` by users in Syria on `2023/3/14 12:41 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
