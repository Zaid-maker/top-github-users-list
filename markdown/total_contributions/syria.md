...
The `public contributions` and `private contributions` by users in Syria on `2024/2/20 11:13 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>204</td>
		<td>
			<a href="https://github.com/karem-obied">
				<img src="https://avatars.githubusercontent.com/u/96317456?s=72&u=afee000fdd723db443fe226022fb87efd2cad0de&v=4" width="24" alt="Avatar of karem-obied"> karem-obied
			</a><br/>
			Karemobied
		</td>
		<td>No Company</td>
