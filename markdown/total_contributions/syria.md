...
The `public contributions` and `private contributions` by users in Syria on `2025/6/13 3:21 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ahmadbariish">
				<img src="https://avatars.githubusercontent.com/u/104466302?s=72&v=4" width="24" alt="Avatar of ahmadbariish"> ahmadbariish
			</a><br/>
			Ahmad Barish
		</td>
		<td>Codyvay </td>
