...
The `public contributions` and `private contributions` by users in Syria on `2024/3/8 7:14 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/SyrianLucianos">SyrianLucianos</a></td>
