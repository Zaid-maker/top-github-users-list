...
The `public contributions` and `private contributions` by users in Syria on `2023/4/12 12:19 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
