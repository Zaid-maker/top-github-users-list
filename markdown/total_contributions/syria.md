...
The `public contributions` and `private contributions` by users in Syria on `2023/2/11 9:13 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
