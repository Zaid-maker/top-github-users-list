...
The `public contributions` and `private contributions` by users in Syria on `2024/4/12 9:16 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
