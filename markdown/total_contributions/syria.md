...
The `public contributions` and `private contributions` by users in Syria on `2024/7/31 8:17 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/sofianabo">
				<img src="https://avatars.githubusercontent.com/u/176797179?s=72&v=4" width="24" alt="Avatar of sofianabo"> sofianabo
			</a><br/>
			Sofian Abo Shdeed
		</td>
		<td>No Company</td>
