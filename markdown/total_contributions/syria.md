...
The `public contributions` and `private contributions` by users in Syria on `2023/3/8 12:49 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
