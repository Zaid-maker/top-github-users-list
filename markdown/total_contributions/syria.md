...
The `public contributions` and `private contributions` by users in Syria on `2023/1/12 9:13 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>142</td>
		<td>
			<a href="https://github.com/abdulrahmanrahhal">
				<img src="https://avatars.githubusercontent.com/u/114484556?s=72&v=4" width="24" alt="Avatar of abdulrahmanrahhal"> abdulrahmanrahhal
			</a><br/>
			Abdulrahman Rahhal
		</td>
		<td>No Company</td>
