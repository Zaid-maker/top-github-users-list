...
The `public contributions` and `private contributions` by users in Syria on `2024/1/16 11:14 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
