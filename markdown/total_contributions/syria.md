...
The `public contributions` and `private contributions` by users in Syria on `2022/12/31 11:11 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
