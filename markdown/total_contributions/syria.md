...
The `public contributions` and `private contributions` by users in Syria on `2023/1/18 9:13 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
