...
The `public contributions` and `private contributions` by users in Guatemala on `2025/5/10 12:30 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/XavierLopez25">
				<img src="https://avatars.githubusercontent.com/u/105880705?s=72&u=7cee1d6a776a596a2f0195506a887f27e9eff7fc&v=4" width="24" alt="Avatar of XavierLopez25"> XavierLopez25
			</a><br/>
			Xavier López (Nathan)
		</td>
		<td>No Company</td>
