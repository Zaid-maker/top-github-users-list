...
The `public contributions` and `private contributions` by users in Guatemala on `2024/12/25 10:20 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jaivalos-dev">
				<img src="https://avatars.githubusercontent.com/u/152330639?s=72&u=8a03b9a9235bc4a5245bb449a88cd40265020361&v=4" width="24" alt="Avatar of jaivalos-dev"> jaivalos-dev
			</a><br/>
