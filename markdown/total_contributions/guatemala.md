...
The `public contributions` and `private contributions` by users in Guatemala on `2025/8/12 6:30 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
...
<table>
	...
	<tr>
		...
		<td>Freelance Bioinformatician </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/checha-afg">
				<img src="https://avatars.githubusercontent.com/u/99372151?s=72&u=293af51156bc62a2455317ef57074eb11b8e4f51&v=4" width="24" alt="Avatar of checha-afg"> checha-afg
			</a><br/>
			Checha
		</td>
		<td>No Company</td>
