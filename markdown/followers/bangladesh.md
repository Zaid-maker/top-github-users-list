...
The `number of followers` of users in Bangladesh on `2024/10/24 12:30 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
