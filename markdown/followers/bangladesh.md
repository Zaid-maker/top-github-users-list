...
The `number of followers` of users in Bangladesh on `2023/5/1 2:41 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
