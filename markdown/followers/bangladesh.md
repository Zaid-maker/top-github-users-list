...
The `number of followers` of users in Bangladesh on `2025/8/16 4:25 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
