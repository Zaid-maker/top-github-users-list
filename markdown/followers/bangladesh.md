...
The `number of followers` of users in Bangladesh on `2025/6/21 6:25 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
