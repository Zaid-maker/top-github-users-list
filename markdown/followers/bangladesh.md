...
The `number of followers` of users in Bangladesh on `2023/5/6 8:14 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
