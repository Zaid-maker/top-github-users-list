...
The `number of followers` of users in Burundi on `2023/3/15 4:12 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
