...
The `number of followers` of users in Burundi on `2023/4/14 3:09 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
