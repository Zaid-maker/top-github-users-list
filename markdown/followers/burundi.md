...
The `number of followers` of users in Burundi on `2025/8/10 8:19 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
