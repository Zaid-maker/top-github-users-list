...
The `number of followers` of users in Burundi on `2024/8/2 12:21 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
