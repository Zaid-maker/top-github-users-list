...
The `number of followers` of users in Burundi on `2023/1/14 2:08 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
