...
The `number of followers` of users in Burundi on `2023/3/21 3:09 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
