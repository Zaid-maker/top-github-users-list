...
The `number of followers` of users in Burundi on `2024/10/19 12:55 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
