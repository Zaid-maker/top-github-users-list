...
The `number of followers` of users in Burundi on `2023/2/25 3:09 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
