...
The `number of followers` of users in Burundi on `2023/4/19 11:10 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
