...
The `number of followers` of users in Senegal on `2024/7/19 3:17 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
...
<table>
	...
	<tr>
		...
		<td>@weekshipper  </td>
		<td><a href="https://twitter.com/X24Ee">X24Ee</a></td>
		<td>Dakar, Sénégal</td>
		<td>3</td>
	</tr>
	<tr>
