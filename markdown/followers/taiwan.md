...
The `number of followers` of users in Taiwan on `2024/3/5 12:45 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
...
<table>
	...
	<tr>
		...
		<td>Senior Ai/software Engineer </td>
		<td>No Twitter Username</td>
		<td>Taiwan, Tainan</td>
		<td>258</td>
	</tr>
