...
The `number of followers` of users in Taiwan on `2024/9/19 12:30 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `970 users`  in Taiwan. You need at least `57 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DezChuang">
				<img src="https://avatars.githubusercontent.com/u/21002750?s=72&u=09579e84404b151613b2dcbdb29a659dadcc0f5a&v=4" width="24" alt="Avatar of DezChuang"> DezChuang
			</a><br/>
			CK Chuang
		</td>
		<td>No Company</td>
