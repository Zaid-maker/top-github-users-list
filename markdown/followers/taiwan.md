...
The `number of followers` of users in Taiwan on `2024/11/24 8:24 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
...
<table>
	...
	<tr>
		<td>437</td>
		<td>
			<a href="https://github.com/naughty-mercy">
				<img src="https://avatars.githubusercontent.com/u/181287241?s=72&v=4" width="24" alt="Avatar of naughty-mercy"> naughty-mercy
			</a><br/>
			Mersy✨
		</td>
		<td>Microsoft  </td>
