...
The `number of followers` of users in Benin on `2024/2/4 12:19 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
