...
The `number of followers` of users in Benin on `2024/6/16 6:18 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
