...
The `number of followers` of users in Cyprus on `2023/5/2 2:36 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
