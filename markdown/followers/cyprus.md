...
The `number of followers` of users in Cyprus on `2023/12/21 8:19 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
