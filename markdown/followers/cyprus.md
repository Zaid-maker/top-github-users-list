...
The `number of followers` of users in Cyprus on `2024/4/15 6:20 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
