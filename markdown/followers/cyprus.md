...
The `number of followers` of users in Cyprus on `2024/12/12 2:22 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
