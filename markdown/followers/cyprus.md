...
The `number of followers` of users in Cyprus on `2025/1/6 1:05 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
