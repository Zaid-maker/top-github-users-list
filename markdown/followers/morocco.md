...
The `number of followers` of users in Morocco on `2024/2/24 3:14 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LinaMahrouch">
				<img src="https://avatars.githubusercontent.com/u/109791074?s=72&u=d2245c4f92f4472b6e02e71752a3e29d37e11781&v=4" width="24" alt="Avatar of LinaMahrouch"> LinaMahrouch
			</a><br/>
			Elina_codes
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>Accesspoint It Solutions </td>
		<td>No Twitter Username</td>
		<td>Morocco</td>
		<td>56</td>
	</tr>
