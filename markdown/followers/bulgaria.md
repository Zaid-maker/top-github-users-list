...
The `number of followers` of users in Bulgaria on `2024/4/26 3:18 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
