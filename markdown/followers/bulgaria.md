...
The `number of followers` of users in Bulgaria on `2025/8/17 3:30 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
