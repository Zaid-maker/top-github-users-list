...
The `number of followers` of users in Bulgaria on `2023/1/2 11:16 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
