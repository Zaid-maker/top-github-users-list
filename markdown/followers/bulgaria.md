...
The `number of followers` of users in Bulgaria on `2023/4/14 2:04 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
