...
The `number of followers` of users in Bulgaria on `2024/1/1 5:17 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
