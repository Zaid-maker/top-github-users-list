...
The `number of followers` of users in Bulgaria on `2023/2/1 12:22 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
