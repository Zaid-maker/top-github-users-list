...
The `number of followers` of users in Bulgaria on `2025/4/20 11:20 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
