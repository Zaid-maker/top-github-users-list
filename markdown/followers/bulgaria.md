...
The `number of followers` of users in Bulgaria on `2024/4/20 9:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
