...
The `number of followers` of users in Bulgaria on `2022/12/25 7:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
