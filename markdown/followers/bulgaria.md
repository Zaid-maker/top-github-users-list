...
The `number of followers` of users in Bulgaria on `2023/5/24 9:12 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
