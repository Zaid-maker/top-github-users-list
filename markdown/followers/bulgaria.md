...
The `number of followers` of users in Bulgaria on `2024/6/28 12:25 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
