...
The `number of followers` of users in Bulgaria on `2023/12/26 11:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
