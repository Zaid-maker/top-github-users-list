...
The `number of followers` of users in Bulgaria on `2025/4/27 3:14 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
