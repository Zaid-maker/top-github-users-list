...
The `number of followers` of users in Bulgaria on `2025/6/27 9:21 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
