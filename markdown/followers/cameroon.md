...
The `number of followers` of users in Cameroon on `2024/4/20 1:16 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
