...
The `number of followers` of users in Cameroon on `2023/12/20 9:15 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
