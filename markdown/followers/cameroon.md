...
The `number of followers` of users in Cameroon on `2023/4/20 2:04 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
