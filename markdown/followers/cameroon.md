...
The `number of followers` of users in Cameroon on `2023/4/14 5:14 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
