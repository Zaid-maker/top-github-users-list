...
The `number of followers` of users in Cameroon on `2023/5/19 3:14 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
