...
The `number of followers` of users in Hungary on `2024/8/9 5:18 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/gpasztor87">
				<img src="https://avatars.githubusercontent.com/u/3843377?s=72&v=4" width="24" alt="Avatar of gpasztor87"> gpasztor87
			</a><br/>
			Pásztor Gábor
		</td>
		<td>No Company</td>
