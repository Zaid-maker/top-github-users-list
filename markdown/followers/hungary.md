...
The `number of followers` of users in Hungary on `2025/5/16 6:27 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `961 users`  in Hungary. You need at least `18 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/KiriGyula">KiriGyula</a></td>
		<td>Budapest, Hungary</td>
		<td>21</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Idomsoft - University Of<br/>Debrecen<br/></td>
		<td>No Twitter Username</td>
		<td>Debrecen</td>
		<td>19</td>
	</tr>
