...
The `number of followers` of users in Hungary on `2024/4/3 6:19 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/mr_andreas_toth">mr_andreas_toth</a></td>
		<td>Budapest, Hungary</td>
		<td>16</td>
	</tr>
	<tr>
