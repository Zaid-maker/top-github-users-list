...
The `number of followers` of users in Belgium on `2024/10/30 2:21 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
