...
The `number of followers` of users in Belgium on `2023/3/9 8:20 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
