...
The `number of followers` of users in Belgium on `2024/12/11 3:24 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
