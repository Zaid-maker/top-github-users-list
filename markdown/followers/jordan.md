...
The `number of followers` of users in Jordan on `2024/7/6 3:19 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
