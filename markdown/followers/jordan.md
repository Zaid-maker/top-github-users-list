...
The `number of followers` of users in Jordan on `2024/4/4 5:15 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
