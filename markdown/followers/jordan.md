...
The `number of followers` of users in Jordan on `2025/6/17 7:21 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
