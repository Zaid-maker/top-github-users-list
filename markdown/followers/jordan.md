...
The `number of followers` of users in Jordan on `2025/5/17 5:20 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
