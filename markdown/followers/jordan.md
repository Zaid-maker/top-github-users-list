...
The `number of followers` of users in Jordan on `2024/4/27 10:15 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
