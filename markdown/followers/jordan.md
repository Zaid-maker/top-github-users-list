...
The `number of followers` of users in Jordan on `2024/1/8 6:18 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
