...
The `number of followers` of users in Jordan on `2024/8/28 12:54 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
