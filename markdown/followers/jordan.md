...
The `number of followers` of users in Jordan on `2024/8/10 5:17 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
