...
The `number of followers` of users in Botswana on `2024/4/26 1:49 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
