...
The `number of followers` of users in Botswana on `2023/5/18 9:10 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
