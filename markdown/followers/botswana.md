...
The `number of followers` of users in Botswana on `2025/7/4 3:21 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
