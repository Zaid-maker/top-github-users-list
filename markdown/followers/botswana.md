...
The `number of followers` of users in Botswana on `2024/12/5 8:21 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
