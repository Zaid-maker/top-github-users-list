...
The `number of followers` of users in Botswana on `2025/8/29 4:22 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
