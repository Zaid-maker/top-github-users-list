...
The `number of followers` of users in Botswana on `2025/5/3 2:33 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
