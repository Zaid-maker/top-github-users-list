...
The `number of followers` of users in Botswana on `2025/3/15 7:15 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
