...
The `number of followers` of users in Botswana on `2023/5/1 9:11 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
