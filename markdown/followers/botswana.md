...
The `number of followers` of users in Botswana on `2023/2/1 10:13 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
