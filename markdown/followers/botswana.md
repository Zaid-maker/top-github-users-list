...
The `number of followers` of users in Botswana on `2024/9/18 11:16 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
