...
The `number of followers` of users in Botswana on `2023/4/13 11:11 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
