...
The `number of followers` of users in Botswana on `2023/4/8 5:10 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
