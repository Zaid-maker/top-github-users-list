...
The `number of followers` of users in Botswana on `2023/1/26 10:12 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
