...
The `number of followers` of users in Botswana on `2024/8/20 4:20 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
