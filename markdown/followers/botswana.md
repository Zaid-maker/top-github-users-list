...
The `number of followers` of users in Botswana on `2025/1/12 2:30 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
