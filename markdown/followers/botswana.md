...
The `number of followers` of users in Botswana on `2025/3/9 6:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
