...
The `number of followers` of users in Botswana on `2024/5/24 7:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
