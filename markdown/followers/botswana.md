...
The `number of followers` of users in Botswana on `2023/3/27 8:15 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
