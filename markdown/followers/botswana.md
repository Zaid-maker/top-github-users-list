...
The `number of followers` of users in Botswana on `2024/1/1 3:14 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
