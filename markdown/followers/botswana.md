...
The `number of followers` of users in Botswana on `2024/4/13 8:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
