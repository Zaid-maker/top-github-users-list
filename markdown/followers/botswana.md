...
The `number of followers` of users in Botswana on `2024/7/10 2:03 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
