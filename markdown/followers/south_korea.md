...
The `number of followers` of users in South Korea on `2024/9/23 4:23 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
