...
The `number of followers` of users in South Korea on `2023/4/6 12:22 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
