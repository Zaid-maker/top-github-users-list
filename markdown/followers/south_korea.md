...
The `number of followers` of users in South Korea on `2025/7/20 11:24 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
