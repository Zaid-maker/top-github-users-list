...
The `number of followers` of users in South Korea on `2023/12/18 10:17 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
