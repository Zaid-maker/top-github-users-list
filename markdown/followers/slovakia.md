...
The `number of followers` of users in Slovakia on `2024/1/16 2:16 PM UTC`. This list contains users from `Slovakia` and cities `Bratislava` `Košice`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/palowashere">
				<img src="https://avatars.githubusercontent.com/u/71690048?s=72&v=4" width="24" alt="Avatar of palowashere"> palowashere
			</a><br/>
			No Name
		</td>
