...
The `number of followers` of users in Vietnam on `2023/12/31 5:16 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
