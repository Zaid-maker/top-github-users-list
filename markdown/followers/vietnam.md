...
The `number of followers` of users in Vietnam on `2024/11/22 8:24 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
