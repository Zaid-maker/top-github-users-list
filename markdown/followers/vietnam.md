...
The `number of followers` of users in Vietnam on `2024/12/29 2:31 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
