...
The `number of followers` of users in Greece on `2024/5/14 2:16 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `961 users`  in Greece. You need at least `26 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/raphaelthegreat">
				<img src="https://avatars.githubusercontent.com/u/47210458?s=72&u=6fd07d65aef4e36b464005401161671858256a61&v=4" width="24" alt="Avatar of raphaelthegreat"> raphaelthegreat
			</a><br/>
			TheTurtle
		</td>
		<td>No Company</td>
