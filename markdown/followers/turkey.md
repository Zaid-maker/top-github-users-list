...
The `number of followers` of users in Turkey on `2024/5/17 6:19 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>@neural-ai-integrati @praise-lab , Previous<br/>@researchmenzies,<br/>@wickingdementia,<br/>@sdg-ai-lab<br/></td>
		<td>No Twitter Username</td>
		<td>Istanbul, Turkey</td>
		<td>154</td>
	</tr>
