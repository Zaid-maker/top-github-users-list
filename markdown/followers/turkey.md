...
The `number of followers` of users in Turkey on `2024/10/11 1:26 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `975 users`  in Turkey. You need at least `128 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/smtdeveloper">
				<img src="https://avatars.githubusercontent.com/u/74311713?s=72&u=1627bb82b7c915531d1c8f880af0a5e89a757f63&v=4" width="24" alt="Avatar of smtdeveloper"> smtdeveloper
			</a><br/>
			Samet Akca
		</td>
