...
The `number of followers` of users in Turkey on `2025/8/27 7:20 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
