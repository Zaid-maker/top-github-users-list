...
The `number of followers` of users in Turkey on `2023/5/11 3:15 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
