...
The `number of followers` of users in Turkey on `2024/11/28 12:23 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `975 users`  in Turkey. You need at least `132 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/hwpplayer1">
				<img src="https://avatars.githubusercontent.com/u/9614451?s=72&u=9910ab2f36764acdf2db8b16660617c1ee3ffae2&v=4" width="24" alt="Avatar of hwpplayer1"> hwpplayer1
			</a><br/>
			Mert Gör 🇹🇷
		</td>
		<td>@masscollabs </td>
	...
	<tr>
		...
		<td>@datamindslab, @neuralailab, @praiselab </td>
