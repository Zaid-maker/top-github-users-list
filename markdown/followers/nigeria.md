...
The `number of followers` of users in Nigeria on `2024/4/5 9:17 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/CodewithSegNet">
				<img src="https://avatars.githubusercontent.com/u/91101596?s=72&u=8541a69130547d19b383fc960578468e81b3f13c&v=4" width="24" alt="Avatar of CodewithSegNet"> CodewithSegNet
			</a><br/>
			Olusegun Emmanuel
		</td>
		<td>No Company</td>
