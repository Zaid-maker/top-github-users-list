...
The `number of followers` of users in Nigeria on `2025/5/12 8:28 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/KidiIT">
				<img src="https://avatars.githubusercontent.com/u/146373396?s=72&v=4" width="24" alt="Avatar of KidiIT"> KidiIT
			</a><br/>
			KIDI'S-TECH
		</td>
	...
	<tr>
		...
		<td>Axxess </td>
		<td><a href="https://twitter.com/FaroukOyekunle">FaroukOyekunle</a></td>
		<td> Lagos State, Nigeria.</td>
		<td>70</td>
	</tr>
	<tr>
