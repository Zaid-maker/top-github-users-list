...
The `number of followers` of users in Slovenia on `2024/3/14 6:19 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
