...
The `number of followers` of users in Slovenia on `2025/8/8 4:25 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
