...
The `number of followers` of users in Slovenia on `2023/3/31 2:17 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
