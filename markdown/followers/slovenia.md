...
The `number of followers` of users in Slovenia on `2024/1/16 3:17 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
