...
The `number of followers` of users in Slovenia on `2024/7/14 12:56 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
