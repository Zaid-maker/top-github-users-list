...
The `number of followers` of users in Slovenia on `2024/4/12 1:50 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
