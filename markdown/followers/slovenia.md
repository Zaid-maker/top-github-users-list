...
The `number of followers` of users in Slovenia on `2023/1/18 1:20 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
