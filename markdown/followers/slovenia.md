...
The `number of followers` of users in Slovenia on `2025/7/8 8:28 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
