...
The `number of followers` of users in Slovenia on `2024/10/16 11:20 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
