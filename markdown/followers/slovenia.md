...
The `number of followers` of users in Slovenia on `2025/6/7 1:11 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
