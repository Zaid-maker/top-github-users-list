...
The `number of followers` of users in Slovenia on `2024/5/17 6:20 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
