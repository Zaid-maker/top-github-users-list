...
The `number of followers` of users in Slovenia on `2025/8/21 5:24 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
