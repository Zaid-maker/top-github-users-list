...
The `number of followers` of users in Slovenia on `2023/5/22 10:14 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
