...
The `number of followers` of users in Slovenia on `2025/4/25 3:43 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
