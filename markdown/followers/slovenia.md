...
The `number of followers` of users in Slovenia on `2023/4/23 7:12 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
