...
The `number of followers` of users in Slovenia on `2023/4/12 4:16 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
