...
The `number of followers` of users in Slovenia on `2024/9/5 4:22 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
