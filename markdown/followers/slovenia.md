...
The `number of followers` of users in Slovenia on `2025/7/2 4:33 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
