...
The `number of followers` of users in Kuwait on `2022/12/27 8:16 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
