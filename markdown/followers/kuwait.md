...
The `number of followers` of users in Kuwait on `2024/2/29 4:16 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
