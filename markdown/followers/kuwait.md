...
The `number of followers` of users in Kuwait on `2024/8/16 8:20 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
