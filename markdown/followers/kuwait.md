...
The `number of followers` of users in Kuwait on `2024/4/10 2:23 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
