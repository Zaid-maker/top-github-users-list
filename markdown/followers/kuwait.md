...
The `number of followers` of users in Kuwait on `2024/2/12 10:18 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
