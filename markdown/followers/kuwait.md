...
The `number of followers` of users in Kuwait on `2023/2/3 12:20 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
