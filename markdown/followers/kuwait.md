...
The `number of followers` of users in Kuwait on `2023/5/3 9:13 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
