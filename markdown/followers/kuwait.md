...
The `number of followers` of users in Kuwait on `2024/9/27 12:58 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
