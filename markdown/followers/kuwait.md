...
The `number of followers` of users in Kuwait on `2023/3/11 3:13 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
