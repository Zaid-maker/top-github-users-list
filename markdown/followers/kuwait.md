...
The `number of followers` of users in Kuwait on `2024/12/26 2:20 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
