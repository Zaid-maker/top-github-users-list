...
The `number of followers` of users in Kuwait on `2024/5/15 7:16 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
