...
The `number of followers` of users in Kuwait on `2024/1/20 10:14 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
