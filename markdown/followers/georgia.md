...
The `number of followers` of users in Georgia on `2024/3/17 5:17 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		<td>923</td>
		<td>
			<a href="https://github.com/MerdyNumber1">
				<img src="https://avatars.githubusercontent.com/u/50208720?s=72&v=4" width="24" alt="Avatar of MerdyNumber1"> MerdyNumber1
			</a><br/>
			Alexey Zasulsky
		</td>
		<td>No Company</td>
