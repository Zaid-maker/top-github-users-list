...
The `number of followers` of users in Georgia on `2025/4/10 2:34 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		<td>902</td>
		<td>
			<a href="https://github.com/LivexTwin">
				<img src="https://avatars.githubusercontent.com/u/127453733?s=72&v=4" width="24" alt="Avatar of LivexTwin"> LivexTwin
			</a><br/>
			Anthony Molina
		</td>
		<td>No Company</td>
