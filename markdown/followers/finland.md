...
The `number of followers` of users in Finland on `2023/5/14 12:46 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
