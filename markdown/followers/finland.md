...
The `number of followers` of users in Finland on `2023/4/9 7:13 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
