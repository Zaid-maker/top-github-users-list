...
The `number of followers` of users in Finland on `2023/1/21 1:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
