...
The `number of followers` of users in Finland on `2023/2/8 1:26 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
