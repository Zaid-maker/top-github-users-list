...
The `number of followers` of users in Finland on `2024/7/28 2:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
...
<table>
	...
	<tr>
		...
		<td>@healthrhythms @awareframework  </td>
