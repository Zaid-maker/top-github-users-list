...
The `number of followers` of users in Finland on `2023/5/8 6:17 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
