...
The `number of followers` of users in Finland on `2023/3/16 3:16 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
