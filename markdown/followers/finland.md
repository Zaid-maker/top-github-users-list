...
The `number of followers` of users in Finland on `2024/10/14 1:03 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
