...
The `number of followers` of users in Finland on `2024/1/2 5:16 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
