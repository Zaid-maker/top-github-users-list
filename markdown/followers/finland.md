...
The `number of followers` of users in Finland on `2024/11/6 9:21 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
