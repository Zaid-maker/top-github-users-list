...
The `number of followers` of users in Afghanistan on `2022/12/24 10:49 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
...
<table>
	...
	<tr>
		<td>715</td>
		<td>
			<a href="https://github.com/LimaEftekhar">
				<img src="https://avatars.githubusercontent.com/u/59239757?s=72&v=4" width="24" alt="Avatar of LimaEftekhar"> LimaEftekhar
			</a><br/>
			Lima Eftekhar 
		</td>
		<td>No Company</td>
