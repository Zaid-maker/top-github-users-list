...
The `number of followers` of users in Mauritania on `2024/9/3 2:12 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
