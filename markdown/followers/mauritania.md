...
The `number of followers` of users in Mauritania on `2024/5/21 12:18 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
