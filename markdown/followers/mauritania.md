...
The `number of followers` of users in Mauritania on `2024/1/20 9:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
