...
The `number of followers` of users in Mauritania on `2023/1/10 11:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
