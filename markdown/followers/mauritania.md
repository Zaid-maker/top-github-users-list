...
The `number of followers` of users in Mauritania on `2023/12/23 2:18 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
