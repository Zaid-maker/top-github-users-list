...
The `number of followers` of users in Mauritania on `2025/2/3 9:13 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
