...
The `number of followers` of users in Mauritania on `2023/4/28 2:34 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
