...
The `number of followers` of users in Mauritania on `2024/4/28 12:16 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
