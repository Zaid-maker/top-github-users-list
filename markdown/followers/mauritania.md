...
The `number of followers` of users in Mauritania on `2025/1/8 12:56 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
