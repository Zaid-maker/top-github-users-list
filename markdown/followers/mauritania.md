...
The `number of followers` of users in Mauritania on `2024/6/2 12:46 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
