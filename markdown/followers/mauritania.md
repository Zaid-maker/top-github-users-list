...
The `number of followers` of users in Mauritania on `2023/3/6 3:16 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
