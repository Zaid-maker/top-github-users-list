...
The `number of followers` of users in Mauritania on `2023/4/16 11:05 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
