...
The `number of followers` of users in Mauritania on `2024/1/3 2:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
