...
The `number of followers` of users in Angola on `2024/10/30 4:23 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
...
<table>
	...
	<tr>
		<td>850</td>
		<td>
			<a href="https://github.com/Levitano">
				<img src="https://avatars.githubusercontent.com/u/153135506?s=72&v=4" width="24" alt="Avatar of Levitano"> Levitano
			</a><br/>
			Inácio Paulo
		</td>
		<td>No Company</td>
