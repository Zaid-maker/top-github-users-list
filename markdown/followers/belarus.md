...
The `number of followers` of users in Belarus on `2024/7/15 3:19 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
