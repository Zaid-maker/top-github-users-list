...
The `number of followers` of users in Belarus on `2024/1/12 10:17 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
