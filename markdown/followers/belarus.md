...
The `number of followers` of users in Belarus on `2024/10/30 1:29 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
