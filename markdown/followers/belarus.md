...
The `number of followers` of users in Belarus on `2023/4/7 11:13 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
