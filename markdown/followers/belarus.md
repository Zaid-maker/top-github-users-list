...
The `number of followers` of users in Belarus on `2023/2/19 5:14 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
