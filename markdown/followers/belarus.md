...
The `number of followers` of users in Belarus on `2024/10/6 4:20 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
