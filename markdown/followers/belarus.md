...
The `number of followers` of users in Belarus on `2024/5/18 7:13 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
