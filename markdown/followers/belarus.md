...
The `number of followers` of users in Belarus on `2024/9/12 6:23 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
