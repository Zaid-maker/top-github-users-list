...
The `number of followers` of users in Belarus on `2024/12/29 6:22 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
