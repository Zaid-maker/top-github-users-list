...
The `number of followers` of users in Belarus on `2024/6/10 9:17 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
