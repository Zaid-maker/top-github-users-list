...
The `number of followers` of users in Switzerland on `2025/8/27 2:23 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
