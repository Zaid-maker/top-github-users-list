...
The `number of followers` of users in Switzerland on `2025/1/3 2:22 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
