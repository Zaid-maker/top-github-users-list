...
The `number of followers` of users in Switzerland on `2024/8/6 4:21 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
