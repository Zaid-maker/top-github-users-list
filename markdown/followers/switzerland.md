...
The `number of followers` of users in Switzerland on `2024/3/14 1:17 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
