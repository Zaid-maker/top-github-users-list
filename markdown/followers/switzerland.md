...
The `number of followers` of users in Switzerland on `2024/8/12 4:22 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
