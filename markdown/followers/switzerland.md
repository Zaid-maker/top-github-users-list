...
The `number of followers` of users in Switzerland on `2024/6/9 3:17 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
