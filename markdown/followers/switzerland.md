...
The `number of followers` of users in Switzerland on `2024/2/20 10:16 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
