...
The `number of followers` of users in Switzerland on `2024/2/14 4:18 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
