...
The `number of followers` of users in Switzerland on `2023/1/18 8:17 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
