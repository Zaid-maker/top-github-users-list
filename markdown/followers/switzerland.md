...
The `number of followers` of users in Switzerland on `2023/1/30 8:16 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
