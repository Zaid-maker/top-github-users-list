...
The `number of followers` of users in Switzerland on `2025/1/23 7:20 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
