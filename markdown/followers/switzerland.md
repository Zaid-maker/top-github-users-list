...
The `number of followers` of users in Switzerland on `2023/4/24 3:16 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
