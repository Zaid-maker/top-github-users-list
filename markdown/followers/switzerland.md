...
The `number of followers` of users in Switzerland on `2025/8/21 12:36 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
