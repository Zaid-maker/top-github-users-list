...
The `number of followers` of users in Switzerland on `2024/7/31 7:18 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
