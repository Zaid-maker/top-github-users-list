...
The `number of followers` of users in Switzerland on `2024/12/10 7:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
