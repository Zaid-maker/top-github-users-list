...
The `number of followers` of users in Switzerland on `2024/5/17 1:19 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
