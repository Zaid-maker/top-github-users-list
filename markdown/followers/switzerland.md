...
The `number of followers` of users in Switzerland on `2023/4/12 11:14 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
