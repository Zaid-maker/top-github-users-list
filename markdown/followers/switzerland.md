...
The `number of followers` of users in Switzerland on `2024/9/5 11:20 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
