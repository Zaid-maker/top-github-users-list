...
The `number of followers` of users in Switzerland on `2025/7/21 6:31 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
