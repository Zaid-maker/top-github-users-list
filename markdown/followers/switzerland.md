...
The `number of followers` of users in Switzerland on `2025/4/1 7:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
