...
The `number of followers` of users in Switzerland on `2025/8/8 11:24 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
