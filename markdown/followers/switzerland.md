...
The `number of followers` of users in Switzerland on `2024/5/23 7:18 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
