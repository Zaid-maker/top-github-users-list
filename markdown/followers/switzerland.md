...
The `number of followers` of users in Switzerland on `2023/4/18 6:18 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
