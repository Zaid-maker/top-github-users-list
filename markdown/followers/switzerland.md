...
The `number of followers` of users in Switzerland on `2025/5/19 6:28 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
