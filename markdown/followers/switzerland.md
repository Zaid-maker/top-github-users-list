...
The `number of followers` of users in Switzerland on `2024/1/22 4:20 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
