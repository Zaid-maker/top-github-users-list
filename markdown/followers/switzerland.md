...
The `number of followers` of users in Switzerland on `2024/11/10 4:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
