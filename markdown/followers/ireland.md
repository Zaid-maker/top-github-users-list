...
The `number of followers` of users in Ireland on `2023/2/21 5:15 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
