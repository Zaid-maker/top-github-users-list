...
The `number of followers` of users in Ireland on `2025/4/22 4:25 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
