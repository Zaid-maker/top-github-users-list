...
The `number of followers` of users in Ireland on `2025/1/20 6:20 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
