...
The `number of followers` of users in Pakistan on `2024/8/11 1:20 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
