...
The `number of followers` of users in Pakistan on `2024/9/22 6:22 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
