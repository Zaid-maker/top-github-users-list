...
The `number of followers` of users in Pakistan on `2024/4/23 11:16 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
