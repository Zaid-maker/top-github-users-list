...
The `number of followers` of users in Pakistan on `2024/1/10 2:31 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
