...
The `number of followers` of users in Pakistan on `2025/1/15 1:27 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
