...
The `number of followers` of users in Pakistan on `2025/4/12 3:36 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
