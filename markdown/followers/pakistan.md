...
The `number of followers` of users in Pakistan on `2024/5/4 11:16 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
