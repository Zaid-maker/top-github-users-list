...
The `number of followers` of users in Pakistan on `2024/6/14 7:18 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
