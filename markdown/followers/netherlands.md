...
The `number of followers` of users in Netherlands on `2023/2/16 11:16 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.
