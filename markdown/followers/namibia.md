...
The `number of followers` of users in Namibia on `2023/4/11 2:01 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
