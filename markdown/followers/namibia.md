...
The `number of followers` of users in Namibia on `2024/6/19 6:16 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
