...
The `number of followers` of users in Namibia on `2024/3/30 9:13 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
