...
The `number of followers` of users in Namibia on `2024/4/28 9:13 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
