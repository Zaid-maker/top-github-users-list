...
The `number of followers` of users in Namibia on `2023/2/10 9:12 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
