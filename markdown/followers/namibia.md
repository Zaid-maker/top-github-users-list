...
The `number of followers` of users in Namibia on `2024/5/21 9:14 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
