...
The `number of followers` of users in Namibia on `2023/1/29 9:11 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
