...
The `number of followers` of users in Namibia on `2023/4/16 8:11 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
