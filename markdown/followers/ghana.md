...
The `number of followers` of users in Ghana on `2022/12/26 1:20 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
...
<table>
	...
	<tr>
		<td>992</td>
		<td>
			<a href="https://github.com/Happen1">
				<img src="https://avatars.githubusercontent.com/u/31631032?s=72&v=4" width="24" alt="Avatar of Happen1"> Happen1
			</a><br/>
			Bright
		</td>
		<td>No Company</td>
