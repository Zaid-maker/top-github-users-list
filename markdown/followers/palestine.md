...
The `number of followers` of users in Palestine on `2025/3/1 6:25 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
