...
The `number of followers` of users in Palestine on `2024/7/19 2:40 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
...
<table>
	...
	<tr>
		...
		<td>⋆⁺｡˚⋆˙‧₊☽ ◯ ☾₊‧˙⋆˚｡⁺⋆ </td>
		<td>No Twitter Username</td>
		<td>pony-towners log off , dni gaza virtue-signallers</td>
		<td>43</td>
	</tr>
	<tr>
		<td>83</td>
