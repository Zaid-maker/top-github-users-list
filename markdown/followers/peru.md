...
The `number of followers` of users in Peru on `2025/1/22 5:21 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
