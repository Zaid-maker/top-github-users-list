...
The `number of followers` of users in Peru on `2025/6/12 1:37 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
