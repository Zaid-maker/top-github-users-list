...
The `number of followers` of users in Peru on `2024/10/4 10:21 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
