...
The `number of followers` of users in Peru on `2025/7/13 10:20 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
