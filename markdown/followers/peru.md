...
The `number of followers` of users in Peru on `2024/1/21 6:17 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
