...
The `number of followers` of users in Peru on `2024/12/3 8:25 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
