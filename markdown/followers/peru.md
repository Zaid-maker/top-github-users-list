...
The `number of followers` of users in Peru on `2024/1/4 11:14 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
