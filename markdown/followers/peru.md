...
The `number of followers` of users in Peru on `2024/1/16 12:48 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
