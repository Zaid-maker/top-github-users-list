...
The `number of followers` of users in Colombia on `2023/2/20 12:49 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
