...
The `number of followers` of users in Colombia on `2025/5/3 3:22 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `765 users`  in Colombia. You need at least `42 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/appitoriadev">
				<img src="https://avatars.githubusercontent.com/u/11842952?s=72&u=edabc4b98e62683a687756eebb5f777a367a06f2&v=4" width="24" alt="Avatar of appitoriadev"> appitoriadev
			</a><br/>
			Laura Velez
		</td>
		<td>No Company</td>
