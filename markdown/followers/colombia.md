...
The `number of followers` of users in Colombia on `2023/4/20 8:17 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
