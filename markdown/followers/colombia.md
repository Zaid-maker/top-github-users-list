...
The `number of followers` of users in Colombia on `2025/6/9 1:36 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
...
<table>
	...
	<tr>
		...
		<td>Servicio Geológico Colombiano </td>
		<td>No Twitter Username</td>
		<td>Colombia</td>
		<td>41</td>
	</tr>
