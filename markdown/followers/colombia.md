...
The `number of followers` of users in Colombia on `2024/11/24 9:20 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
