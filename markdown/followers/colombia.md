...
The `number of followers` of users in Colombia on `2024/12/30 4:23 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
