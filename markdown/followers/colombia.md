...
The `number of followers` of users in Colombia on `2024/8/2 9:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
...
<table>
	...
	<tr>
		...
		<td>Fastapi </td>
		<td><a href="https://twitter.com/alejsdev">alejsdev</a></td>
		<td>Medellín, Colombia</td>
		<td>113</td>
	</tr>
	<tr>
