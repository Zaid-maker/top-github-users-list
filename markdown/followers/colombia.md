...
The `number of followers` of users in Colombia on `2023/2/13 11:15 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
