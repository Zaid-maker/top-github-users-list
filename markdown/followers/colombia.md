...
The `number of followers` of users in Colombia on `2023/1/20 11:14 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
