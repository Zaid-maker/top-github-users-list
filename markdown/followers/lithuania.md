...
The `number of followers` of users in Lithuania on `2025/7/18 9:24 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
