...
The `number of followers` of users in Lithuania on `2024/3/29 4:18 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
