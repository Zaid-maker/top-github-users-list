...
The `number of followers` of users in Lithuania on `2025/8/13 1:10 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
