...
The `number of followers` of users in Lithuania on `2024/7/12 4:20 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
