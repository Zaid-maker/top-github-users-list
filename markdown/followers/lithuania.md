...
The `number of followers` of users in Lithuania on `2024/1/9 12:49 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
