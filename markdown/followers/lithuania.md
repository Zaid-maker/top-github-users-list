...
The `number of followers` of users in Lithuania on `2023/1/22 3:15 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
