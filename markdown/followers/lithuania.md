...
The `number of followers` of users in Lithuania on `2024/8/10 11:18 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
