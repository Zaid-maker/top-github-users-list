...
The `number of followers` of users in Saudi Arabia on `2025/2/17 5:19 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
