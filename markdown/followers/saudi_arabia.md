...
The `number of followers` of users in Saudi Arabia on `2024/12/15 6:23 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
