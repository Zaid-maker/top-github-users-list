...
The `number of followers` of users in Saudi Arabia on `2024/3/2 9:14 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
