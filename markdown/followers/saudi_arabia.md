...
The `number of followers` of users in Saudi Arabia on `2023/5/22 4:15 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
