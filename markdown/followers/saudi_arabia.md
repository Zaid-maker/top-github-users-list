...
The `number of followers` of users in Saudi Arabia on `2023/1/18 7:14 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
