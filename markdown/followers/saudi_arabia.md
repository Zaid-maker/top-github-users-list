...
The `number of followers` of users in Saudi Arabia on `2025/5/19 5:22 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
