...
The `number of followers` of users in Saudi Arabia on `2024/2/2 3:16 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
