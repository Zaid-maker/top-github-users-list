...
The `number of followers` of users in Saudi Arabia on `2023/1/6 6:17 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
