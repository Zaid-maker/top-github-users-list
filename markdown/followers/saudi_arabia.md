...
The `number of followers` of users in Saudi Arabia on `2023/4/6 4:15 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
