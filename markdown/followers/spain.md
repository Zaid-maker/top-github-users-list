...
The `number of followers` of users in Spain on `2023/4/12 7:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
