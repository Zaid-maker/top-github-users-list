...
The `number of followers` of users in Spain on `2023/1/24 4:19 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
