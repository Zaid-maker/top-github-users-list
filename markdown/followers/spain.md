...
The `number of followers` of users in Spain on `2023/12/24 5:15 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
