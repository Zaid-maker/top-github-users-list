...
The `number of followers` of users in Spain on `2025/1/23 3:25 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
