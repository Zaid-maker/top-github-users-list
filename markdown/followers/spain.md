...
The `number of followers` of users in Spain on `2023/2/5 4:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
