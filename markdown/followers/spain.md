...
The `number of followers` of users in Spain on `2023/4/23 10:15 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
