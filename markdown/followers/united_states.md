...
The `number of followers` of users in United States on `2024/2/3 2:15 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
