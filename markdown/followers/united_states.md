...
The `number of followers` of users in United States on `2024/3/20 5:18 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
