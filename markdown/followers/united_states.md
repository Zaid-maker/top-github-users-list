...
The `number of followers` of users in United States on `2024/4/30 5:20 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
