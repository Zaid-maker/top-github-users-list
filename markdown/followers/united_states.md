...
The `number of followers` of users in United States on `2024/12/4 5:26 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
