...
The `number of followers` of users in Jamaica on `2023/1/4 6:17 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
