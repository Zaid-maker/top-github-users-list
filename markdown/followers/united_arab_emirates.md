...
The `number of followers` of users in United Arab Emirates on `2025/8/9 9:14 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
