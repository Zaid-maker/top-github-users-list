...
The `number of followers` of users in United Arab Emirates on `2024/7/14 4:18 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
