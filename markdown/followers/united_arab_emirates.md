...
The `number of followers` of users in United Arab Emirates on `2023/4/1 5:06 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
