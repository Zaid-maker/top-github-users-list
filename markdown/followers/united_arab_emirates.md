...
The `number of followers` of users in United Arab Emirates on `2024/1/28 6:09 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
