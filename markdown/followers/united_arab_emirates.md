...
The `number of followers` of users in United Arab Emirates on `2025/6/26 12:27 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
