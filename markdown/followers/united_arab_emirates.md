...
The `number of followers` of users in United Arab Emirates on `2023/2/18 6:09 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
