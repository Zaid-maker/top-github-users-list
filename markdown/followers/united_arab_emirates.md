...
The `number of followers` of users in United Arab Emirates on `2025/6/7 4:15 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
