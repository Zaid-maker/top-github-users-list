...
The `number of followers` of users in United Arab Emirates on `2024/10/29 1:22 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
