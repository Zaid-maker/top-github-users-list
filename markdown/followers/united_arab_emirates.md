...
The `number of followers` of users in United Arab Emirates on `2025/7/27 7:11 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
