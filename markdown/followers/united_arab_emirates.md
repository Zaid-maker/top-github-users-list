...
The `number of followers` of users in United Arab Emirates on `2025/4/19 4:15 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
