...
The `number of followers` of users in United Arab Emirates on `2023/5/5 11:06 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
