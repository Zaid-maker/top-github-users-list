...
The `number of followers` of users in United Arab Emirates on `2024/5/23 3:10 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
