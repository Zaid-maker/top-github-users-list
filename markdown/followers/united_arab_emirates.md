...
The `number of followers` of users in United Arab Emirates on `2023/1/1 4:08 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
