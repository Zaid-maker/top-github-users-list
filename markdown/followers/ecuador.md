...
The `number of followers` of users in Ecuador on `2024/2/5 1:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
