...
The `number of followers` of users in Ecuador on `2023/2/20 9:17 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
