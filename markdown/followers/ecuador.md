...
The `number of followers` of users in Ecuador on `2023/1/3 7:15 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
