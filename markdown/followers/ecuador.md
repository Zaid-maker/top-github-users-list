...
The `number of followers` of users in Ecuador on `2023/4/14 8:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
