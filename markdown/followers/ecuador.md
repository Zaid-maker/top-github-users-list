...
The `number of followers` of users in Ecuador on `2023/5/2 6:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
