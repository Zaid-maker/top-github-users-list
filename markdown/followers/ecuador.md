...
The `number of followers` of users in Ecuador on `2025/5/3 11:20 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
