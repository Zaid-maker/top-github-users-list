...
The `number of followers` of users in Ecuador on `2023/4/9 2:36 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
