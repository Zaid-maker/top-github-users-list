...
The `number of followers` of users in Myanmar on `2023/1/29 8:15 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
...
<table>
	...
	<tr>
		<td>914</td>
		<td>
			<a href="https://github.com/Yemintun27">
				<img src="https://avatars.githubusercontent.com/u/92627795?s=72&v=4" width="24" alt="Avatar of Yemintun27"> Yemintun27
			</a><br/>
			Yemin Tun
		</td>
		<td>Hnin Pwint (snow Petal)<br/>Guest<br/>House<br/></td>
		<td><a href="https://twitter.com/yemintundedee">yemintundedee</a></td>
		<td>Puta-O Kachin State Myanmar</td>
		<td>4</td>
	</tr>
	<tr>
		<td>915</td>
