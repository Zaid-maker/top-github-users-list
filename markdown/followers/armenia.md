...
The `number of followers` of users in Armenia on `2025/7/3 1:35 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
