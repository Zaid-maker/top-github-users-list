...
The `number of followers` of users in Tanzania on `2025/1/30 5:18 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
