...
The `number of followers` of users in Tanzania on `2023/12/30 5:14 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
