...
The `number of followers` of users in Tanzania on `2025/5/1 2:20 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
