...
The `number of followers` of users in Tanzania on `2025/1/3 4:22 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
