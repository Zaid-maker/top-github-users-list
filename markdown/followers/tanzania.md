...
The `number of followers` of users in Tanzania on `2023/12/24 11:15 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
