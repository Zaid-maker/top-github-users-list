...
The `number of followers` of users in Montenegro on `2024/5/27 11:16 AM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/drive4dev">
				<img src="https://avatars.githubusercontent.com/u/24931673?s=72&v=4" width="24" alt="Avatar of drive4dev"> drive4dev
			</a><br/>
			Maksim Dubinin
		</td>
		<td>No Company</td>
