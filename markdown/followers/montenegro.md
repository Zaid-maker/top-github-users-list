...
The `number of followers` of users in Montenegro on `2024/9/27 5:18 PM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.
