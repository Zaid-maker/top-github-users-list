...
The `number of followers` of users in Uganda on `2025/5/7 7:19 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
...
<table>
	...
	<tr>
		<td>889</td>
		<td>
			<a href="https://github.com/Wandera-Martin">
				<img src="https://avatars.githubusercontent.com/u/44434438?s=72&v=4" width="24" alt="Avatar of Wandera-Martin"> Wandera-Martin
			</a><br/>
			Martin Wandera
		</td>
		<td>No Company</td>
