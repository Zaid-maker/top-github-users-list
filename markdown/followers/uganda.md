...
The `number of followers` of users in Uganda on `2025/1/3 8:21 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/petermulinzi">petermulinzi</a></td>
		<td>Kampala Uganda</td>
		<td>9</td>
	</tr>
	<tr>
