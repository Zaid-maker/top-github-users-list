...
The `number of followers` of users in Uganda on `2024/5/12 2:02 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `970 users`  in Uganda. You need at least `6 followers` to be on this list.
