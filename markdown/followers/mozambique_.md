...
The `number of followers` of users in Mozambique  on `2023/5/9 10:12 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
