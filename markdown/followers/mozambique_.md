...
The `number of followers` of users in Mozambique  on `2024/4/23 1:51 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
