...
The `number of followers` of users in Mozambique  on `2025/2/28 6:24 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
