...
The `number of followers` of users in Mozambique  on `2024/6/19 4:18 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
