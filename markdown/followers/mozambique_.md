...
The `number of followers` of users in Mozambique  on `2025/5/24 6:24 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
