...
The `number of followers` of users in Mozambique  on `2023/1/29 7:12 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
