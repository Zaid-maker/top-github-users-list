...
The `number of followers` of users in Mozambique  on `2024/5/16 1:57 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
