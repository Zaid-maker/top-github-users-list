...
The `number of followers` of users in Mozambique  on `2024/12/26 8:20 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
