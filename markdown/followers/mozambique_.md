...
The `number of followers` of users in Mozambique  on `2025/6/18 6:27 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
