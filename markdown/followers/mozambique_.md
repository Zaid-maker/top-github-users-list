...
The `number of followers` of users in Mozambique  on `2023/2/22 8:16 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
