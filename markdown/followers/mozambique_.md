...
The `number of followers` of users in Mozambique  on `2024/5/27 1:17 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
