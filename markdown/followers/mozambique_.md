...
The `number of followers` of users in Mozambique  on `2024/9/27 7:16 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
