...
The `number of followers` of users in Mozambique  on `2024/4/5 2:22 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
