...
The `number of followers` of users in Mozambique  on `2023/4/16 6:14 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
