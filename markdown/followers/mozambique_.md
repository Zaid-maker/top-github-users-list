...
The `number of followers` of users in Mozambique  on `2024/1/9 4:17 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
