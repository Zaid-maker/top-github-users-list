...
The `number of followers` of users in Mozambique  on `2023/3/18 9:13 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
