...
The `number of followers` of users in South Africa on `2024/7/25 5:17 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
