...
The `number of followers` of users in South Africa on `2024/12/4 1:07 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
