...
The `number of followers` of users in South Africa on `2023/4/12 5:14 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
