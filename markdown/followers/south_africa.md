...
The `number of followers` of users in South Africa on `2025/6/7 2:53 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
