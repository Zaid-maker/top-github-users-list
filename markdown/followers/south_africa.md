...
The `number of followers` of users in South Africa on `2023/5/22 11:15 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
