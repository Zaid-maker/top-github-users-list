...
The `number of followers` of users in South Africa on `2024/4/12 2:28 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
