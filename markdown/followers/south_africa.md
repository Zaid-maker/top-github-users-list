...
The `number of followers` of users in South Africa on `2024/9/11 5:20 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
