...
The `number of followers` of users in South Africa on `2025/1/23 11:20 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
