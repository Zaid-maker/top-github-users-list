...
The `number of followers` of users in South Africa on `2023/3/19 4:16 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
