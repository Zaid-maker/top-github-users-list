...
The `number of followers` of users in Latvia on `2025/2/28 2:26 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kitaminka">
				<img src="https://avatars.githubusercontent.com/u/54278668?s=72&v=4" width="24" alt="Avatar of kitaminka"> kitaminka
			</a><br/>
			Nikita
		</td>
		<td>No Company</td>
