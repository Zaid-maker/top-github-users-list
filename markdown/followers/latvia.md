...
The `number of followers` of users in Latvia on `2024/7/12 3:19 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/sorokin_vl">sorokin_vl</a></td>
		<td>Riga</td>
		<td>5</td>
	</tr>
	<tr>
