...
The `number of followers` of users in Latvia on `2025/1/28 6:25 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		<td>944</td>
		<td>
			<a href="https://github.com/kiko02">
				<img src="https://avatars.githubusercontent.com/u/10011033?s=72&v=4" width="24" alt="Avatar of kiko02"> kiko02
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
