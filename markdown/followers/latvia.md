...
The `number of followers` of users in Latvia on `2025/5/11 7:21 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/yaroslav_ilin_">yaroslav_ilin_</a></td>
		<td>Daugavpils, Latvia</td>
		<td>17</td>
	</tr>
	<tr>
