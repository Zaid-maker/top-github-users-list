...
The `number of followers` of users in Latvia on `2024/12/7 11:20 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		<td>853</td>
		<td>
			<a href="https://github.com/avjgit">
				<img src="https://avatars.githubusercontent.com/u/432870?s=72&v=4" width="24" alt="Avatar of avjgit"> avjgit
			</a><br/>
			AJ
		</td>
		<td>No Company</td>
