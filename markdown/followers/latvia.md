...
The `number of followers` of users in Latvia on `2024/11/13 11:20 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>Riga State Technical School<br/></td>
		<td>No Twitter Username</td>
		<td>Latvia, Riga</td>
		<td>84</td>
	</tr>
