...
The `number of followers` of users in Philippines on `2023/12/24 12:50 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
