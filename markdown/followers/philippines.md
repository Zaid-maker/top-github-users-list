...
The `number of followers` of users in Philippines on `2023/3/13 2:15 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
