...
The `number of followers` of users in Philippines on `2024/1/27 1:15 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/xuronno">
				<img src="https://avatars.githubusercontent.com/u/68635840?s=72&v=4" width="24" alt="Avatar of xuronno"> xuronno
			</a><br/>
			Justin Pascual
		</td>
