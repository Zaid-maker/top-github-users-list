...
The `number of followers` of users in Philippines on `2024/3/13 4:18 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
