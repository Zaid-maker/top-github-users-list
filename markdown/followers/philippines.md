...
The `number of followers` of users in Philippines on `2023/3/7 2:33 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
