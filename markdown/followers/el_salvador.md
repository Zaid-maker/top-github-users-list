...
The `number of followers` of users in El Salvador on `2023/12/27 8:17 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
