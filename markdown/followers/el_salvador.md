...
The `number of followers` of users in El Salvador on `2025/4/15 9:20 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
