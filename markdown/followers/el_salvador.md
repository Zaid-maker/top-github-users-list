...
The `number of followers` of users in El Salvador on `2023/4/20 6:15 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
