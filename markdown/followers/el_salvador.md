...
The `number of followers` of users in El Salvador on `2023/3/10 1:25 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
