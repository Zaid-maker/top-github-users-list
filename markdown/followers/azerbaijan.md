...
The `number of followers` of users in Azerbaijan on `2024/4/1 11:16 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
