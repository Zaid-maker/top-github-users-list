...
The `number of followers` of users in Azerbaijan on `2024/9/6 3:20 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
