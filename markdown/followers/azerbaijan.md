...
The `number of followers` of users in Azerbaijan on `2023/4/7 8:14 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
