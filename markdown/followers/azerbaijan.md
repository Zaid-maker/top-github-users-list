...
The `number of followers` of users in Azerbaijan on `2025/6/8 1:30 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
