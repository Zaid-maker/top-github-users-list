...
The `number of followers` of users in Luxembourg on `2024/1/26 8:18 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.
...
<table>
	...
	<tr>
		<td>891</td>
		<td>
			<a href="https://github.com/AlexCharles205">
				<img src="https://avatars.githubusercontent.com/u/119506241?s=72&v=4" width="24" alt="Avatar of AlexCharles205"> AlexCharles205
			</a><br/>
			Alex Charlès
		</td>
		<td>University Of Luxembourg -<br/>Cryptolux<br/></td>
		<td>No Twitter Username</td>
		<td>Luxembourg</td>
		<td>3</td>
	</tr>
