...
The `number of followers` of users in Luxembourg on `2025/2/16 3:26 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.
...
<table>
	...
	<tr>
		<td>840</td>
		<td>
			<a href="https://github.com/bouchoua2u">
				<img src="https://avatars.githubusercontent.com/u/3789163?s=72&v=4" width="24" alt="Avatar of bouchoua2u"> bouchoua2u
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
