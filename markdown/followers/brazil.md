...
The `number of followers` of users in Brazil on `2024/10/18 9:22 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `951 users`  in Brazil. You need at least `242 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/yurialvs">
				<img src="https://avatars.githubusercontent.com/u/136497786?s=72&u=c1d03998c0ebf573840114e094d2f3f3c4d8f5bc&v=4" width="24" alt="Avatar of yurialvs"> yurialvs
			</a><br/>
			Yuri
		</td>
