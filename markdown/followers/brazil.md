...
The `number of followers` of users in Brazil on `2024/9/7 2:14 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
...
<table>
	...
	<tr>
		...
		<td>@woneylabs @vifesolutions @stone-payments </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MatheuZSecurity">
				<img src="https://avatars.githubusercontent.com/u/88067225?s=72&u=f52fee844f8851264b16f0f3ed6f2f704e049c18&v=4" width="24" alt="Avatar of MatheuZSecurity"> MatheuZSecurity
			</a><br/>
			matheuz
		</td>
		<td>Bebop </td>
