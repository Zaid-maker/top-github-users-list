...
The `number of followers` of users in Brazil on `2025/3/9 7:19 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `949 users`  in Brazil. You need at least `255 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/WSTxda">
				<img src="https://avatars.githubusercontent.com/u/37253994?s=72&u=e109a55c51b6e299dd402c99d99241e63d284b10&v=4" width="24" alt="Avatar of WSTxda"> WSTxda
			</a><br/>
			WSTxda
		</td>
		<td>Wstprojects </td>
