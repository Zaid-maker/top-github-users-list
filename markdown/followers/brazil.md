...
The `number of followers` of users in Brazil on `2024/10/6 11:20 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `951 users`  in Brazil. You need at least `241 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>42</td>
		<td>
			<a href="https://github.com/renominated">
				<img src="https://avatars.githubusercontent.com/u/149725576?s=72&u=c8efbd16529a515d01952596860a1c65b3ea18f9&v=4" width="24" alt="Avatar of renominated"> renominated
			</a><br/>
			No Name
		</td>
		<td>High Class </td>
