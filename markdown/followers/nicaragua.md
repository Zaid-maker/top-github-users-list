...
The `number of followers` of users in Nicaragua on `2025/6/12 5:21 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
