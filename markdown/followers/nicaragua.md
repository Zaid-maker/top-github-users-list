...
The `number of followers` of users in Nicaragua on `2024/8/5 10:18 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
