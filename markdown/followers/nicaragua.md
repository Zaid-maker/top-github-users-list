...
The `number of followers` of users in Nicaragua on `2024/6/2 1:16 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
