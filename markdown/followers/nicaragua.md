...
The `number of followers` of users in Nicaragua on `2024/7/24 5:17 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
