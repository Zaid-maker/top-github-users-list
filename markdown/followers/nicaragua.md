...
The `number of followers` of users in Nicaragua on `2025/6/24 6:26 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
