...
The `number of followers` of users in Nicaragua on `2024/10/21 10:19 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
