...
The `number of followers` of users in Nicaragua on `2025/4/30 4:23 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
