...
The `number of followers` of users in Nicaragua on `2024/1/27 4:16 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
