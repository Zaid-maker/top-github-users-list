...
The `number of followers` of users in Nicaragua on `2024/8/11 9:19 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
