...
The `number of followers` of users in Nicaragua on `2024/11/26 10:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
