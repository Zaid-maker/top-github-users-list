...
The `number of followers` of users in Nicaragua on `2025/5/24 12:30 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
