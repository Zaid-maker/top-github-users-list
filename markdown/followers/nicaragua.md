...
The `number of followers` of users in Nicaragua on `2024/12/8 11:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
