...
The `number of followers` of users in Nicaragua on `2023/12/17 9:14 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
