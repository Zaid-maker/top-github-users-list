...
The `number of followers` of users in Nicaragua on `2024/12/21 2:21 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
