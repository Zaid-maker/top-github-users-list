...
The `number of followers` of users in Nicaragua on `2024/6/19 10:16 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
