...
The `number of followers` of users in Nicaragua on `2024/7/13 2:04 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
