...
The `number of followers` of users in Nicaragua on `2024/3/30 1:17 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
