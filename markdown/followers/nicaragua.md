...
The `number of followers` of users in Nicaragua on `2024/5/16 7:14 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
