...
The `number of followers` of users in Nicaragua on `2025/1/8 2:20 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
