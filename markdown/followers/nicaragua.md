...
The `number of followers` of users in Nicaragua on `2025/1/2 6:24 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
