...
The `number of followers` of users in Nicaragua on `2025/8/20 5:22 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
