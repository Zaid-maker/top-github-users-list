...
The `number of followers` of users in Sri Lanka on `2023/4/18 3:15 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
