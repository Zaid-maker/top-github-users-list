...
The `number of followers` of users in Sri Lanka on `2023/3/19 7:13 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
