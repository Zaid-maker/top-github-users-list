...
The `number of followers` of users in Poland on `2023/12/24 2:02 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
