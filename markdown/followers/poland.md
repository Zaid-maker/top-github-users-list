...
The `number of followers` of users in Poland on `2024/1/16 2:34 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
