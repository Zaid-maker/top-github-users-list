...
The `number of followers` of users in Poland on `2024/9/16 1:30 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
