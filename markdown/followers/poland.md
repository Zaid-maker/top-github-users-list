...
The `number of followers` of users in Poland on `2023/2/4 11:15 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
