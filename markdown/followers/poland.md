...
The `number of followers` of users in Poland on `2024/10/4 12:31 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
