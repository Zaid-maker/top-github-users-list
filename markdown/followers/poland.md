...
The `number of followers` of users in Poland on `2024/1/10 8:21 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
