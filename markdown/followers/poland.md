...
The `number of followers` of users in Poland on `2025/4/12 9:22 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
