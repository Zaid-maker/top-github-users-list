...
The `number of followers` of users in Poland on `2025/1/9 12:59 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
