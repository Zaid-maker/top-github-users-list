...
The `number of followers` of users in Poland on `2023/4/23 6:18 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
