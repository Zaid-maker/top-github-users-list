...
The `number of followers` of users in Poland on `2024/6/2 11:18 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
