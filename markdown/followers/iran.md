...
The `number of followers` of users in Iran on `2024/12/19 2:14 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
