...
The `number of followers` of users in Iran on `2024/9/14 4:19 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
