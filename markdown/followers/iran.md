...
The `number of followers` of users in Iran on `2024/10/14 1:30 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
