...
The `number of followers` of users in Iran on `2023/4/9 7:11 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
