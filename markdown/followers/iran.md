...
The `number of followers` of users in Iran on `2023/5/14 1:14 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
