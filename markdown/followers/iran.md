...
The `number of followers` of users in Iran on `2023/4/27 5:14 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
