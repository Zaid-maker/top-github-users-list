...
The `number of followers` of users in Venezuela on `2024/11/22 7:19 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/rodriguez">rodriguez</a></td>
		<td>Caracas, Venezuela</td>
		<td>9</td>
	</tr>
	<tr>
