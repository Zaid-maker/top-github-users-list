...
The `number of followers` of users in Venezuela on `2023/3/20 12:22 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
