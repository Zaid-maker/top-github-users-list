...
The `number of followers` of users in Venezuela on `2024/5/29 2:17 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
