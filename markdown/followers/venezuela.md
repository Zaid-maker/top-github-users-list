...
The `number of followers` of users in Venezuela on `2025/8/9 2:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
...
<table>
	...
	<tr>
		<td>936</td>
		<td>
			<a href="https://github.com/cexareds">
				<img src="https://avatars.githubusercontent.com/u/77209533?s=72&v=4" width="24" alt="Avatar of cexareds"> cexareds
			</a><br/>
			César Rojas
		</td>
		<td>No Company</td>
