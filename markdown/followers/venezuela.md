...
The `number of followers` of users in Venezuela on `2023/4/24 4:16 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
