...
The `number of followers` of users in Venezuela on `2025/7/15 1:40 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
