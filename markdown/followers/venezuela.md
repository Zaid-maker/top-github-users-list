...
The `number of followers` of users in Venezuela on `2024/5/18 2:29 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
