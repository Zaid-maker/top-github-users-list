...
The `number of followers` of users in Venezuela on `2025/7/3 1:13 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
