...
The `number of followers` of users in Venezuela on `2024/6/21 5:18 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
