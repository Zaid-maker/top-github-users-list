...
The `number of followers` of users in Venezuela on `2024/12/16 9:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
