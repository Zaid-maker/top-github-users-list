...
The `number of followers` of users in Venezuela on `2023/1/31 10:15 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
