...
The `number of followers` of users in Venezuela on `2025/5/14 6:27 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
