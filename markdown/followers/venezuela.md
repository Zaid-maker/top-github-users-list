...
The `number of followers` of users in Venezuela on `2024/8/13 6:23 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
