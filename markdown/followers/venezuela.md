...
The `number of followers` of users in Venezuela on `2023/3/2 11:14 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
