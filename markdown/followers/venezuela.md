...
The `number of followers` of users in Venezuela on `2023/1/25 10:16 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
