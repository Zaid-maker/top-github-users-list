...
The `number of followers` of users in Kenya on `2025/2/9 8:23 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `913 users`  in Kenya. You need at least `67 followers` to be on this list.
