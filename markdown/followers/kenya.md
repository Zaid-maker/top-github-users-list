...
The `number of followers` of users in Kenya on `2024/10/2 10:21 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
