...
The `number of followers` of users in Kenya on `2025/4/10 8:23 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `984 users`  in Kenya. You need at least `65 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/iberniex">
				<img src="https://avatars.githubusercontent.com/u/38454352?s=72&u=2976ba1119d63004bfa33e2b17f2c9fdd94fe496&v=4" width="24" alt="Avatar of iberniex"> iberniex
			</a><br/>
			Ben Karanja
		</td>
		<td>No Company</td>
