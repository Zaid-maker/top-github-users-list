...
The `public contributions` by users in Botswana on `2022/12/25 5:10 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
