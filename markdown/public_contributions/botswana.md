...
The `public contributions` by users in Botswana on `2023/4/19 7:10 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
