...
The `public contributions` by users in Botswana on `2023/5/12 10:11 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
