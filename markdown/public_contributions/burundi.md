...
The `public contributions` by users in Burundi on `2024/6/22 8:11 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `417 users`  in Burundi. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Venasetabo">
				<img src="https://avatars.githubusercontent.com/u/165334672?s=72&v=4" width="24" alt="Avatar of Venasetabo"> Venasetabo
			</a><br/>
			Rashidi Etabo
		</td>
		<td>@code-our-work </td>
