...
The `public contributions` by users in Jordan on `2025/7/18 3:22 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
...
<table>
	...
	<tr>
		...
		<td>No Twitter Username</td>
		<td>~Besties/Pookies~!ILY!~ Leah, Kaeya, Nerdy, Screwllum, Iza, Armin, Shima, Oli/Rainy, Ash/Ashley, Eclipse, Esther, Jordan, Darkie, Bladie, Hurricane/Elliott, Apple/Kiara</td>
		<td>64</td>
	</tr>
	<tr>
		<td>181</td>
