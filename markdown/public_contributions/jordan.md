...
The `public contributions` by users in Jordan on `2025/2/27 8:21 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `976 users`  in Jordan. You need at least `8 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>42 Amman, Optimum Partners<br/></td>
