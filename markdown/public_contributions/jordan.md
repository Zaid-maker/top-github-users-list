...
The `public contributions` by users in Jordan on `2025/5/23 8:26 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
...
<table>
	...
	<tr>
		<td>185</td>
		<td>
			<a href="https://github.com/jklz">
				<img src="https://avatars.githubusercontent.com/u/141406?s=72&v=4" width="24" alt="Avatar of jklz"> jklz
			</a><br/>
			Jared Spencer
		</td>
		<td>No Company</td>
