...
The `public contributions` by users in Jordan on `2023/2/21 10:16 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
