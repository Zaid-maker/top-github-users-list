...
The `public contributions` by users in Jordan on `2025/7/31 4:44 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
