...
The `public contributions` by users in Jordan on `2025/2/3 7:20 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/HamzaUpgrade">
				<img src="https://avatars.githubusercontent.com/u/49615694?s=72&u=5355f1cee95f1dc27d9a5dd8abb4f0aecdb9ea47&v=4" width="24" alt="Avatar of HamzaUpgrade"> HamzaUpgrade
			</a><br/>
			Hamza Abdulrahman
		</td>
		<td>No Company</td>
