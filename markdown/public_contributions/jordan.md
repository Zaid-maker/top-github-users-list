...
The `public contributions` by users in Jordan on `2023/5/20 6:14 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
