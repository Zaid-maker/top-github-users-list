...
The `public contributions` by users in Jordan on `2024/8/22 2:11 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
...
<table>
	...
	<tr>
		...
		<td>Electronic Health Solutions (ehs)<br/></td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bayankhatib">
				<img src="https://avatars.githubusercontent.com/u/79087573?s=72&v=4" width="24" alt="Avatar of bayankhatib"> bayankhatib
			</a><br/>
			Bayan Alkhatib
		</td>
		<td>No Company</td>
