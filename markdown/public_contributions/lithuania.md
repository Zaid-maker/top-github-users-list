...
The `public contributions` by users in Lithuania on `2025/5/17 11:21 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `953 users`  in Lithuania. You need at least `10 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/O-Julia-O">
				<img src="https://avatars.githubusercontent.com/u/81177974?s=72&u=98c1d06560ba08bb2301e6541ecf09576a99f3e5&v=4" width="24" alt="Avatar of O-Julia-O"> O-Julia-O
			</a><br/>
			Julia
		</td>
		<td>No Company</td>
