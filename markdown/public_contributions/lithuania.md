...
The `public contributions` by users in Lithuania on `2025/7/25 4:43 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `955 users`  in Lithuania. You need at least `10 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/matas3535">
				<img src="https://avatars.githubusercontent.com/u/102203325?s=72&u=ebfbace576bec93e24b6de1fd88a245e9d64d5e1&v=4" width="24" alt="Avatar of matas3535"> matas3535
			</a><br/>
			matas
		</td>
		<td>Atlanta.gg </td>
