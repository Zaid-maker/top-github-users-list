...
The `public contributions` by users in Lithuania on `2024/10/21 1:03 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `958 users`  in Lithuania. You need at least `9 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Thered.sh Development Group, Delta<br/>Studios<br/></td>
		<td>No Twitter Username</td>
		<td>Lithuania</td>
		<td>63</td>
	</tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/pbrilius">
				<img src="https://avatars.githubusercontent.com/u/8288767?s=72&u=32274b38f42b2bfb5b8f9355d8a74168522c2f4e&v=4" width="24" alt="Avatar of pbrilius"> pbrilius
			</a><br/>
			Povilas Brilius
		</td>
		<td>Pb </td>
