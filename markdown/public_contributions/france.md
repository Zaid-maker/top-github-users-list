...
The `public contributions` by users in France on `2025/7/24 3:38 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `922 users`  in France. You need at least `207 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Linux-Scratcher">
				<img src="https://avatars.githubusercontent.com/u/122288570?s=72&u=16de00457e85f874adb8f14bf78bd4126b44112e&v=4" width="24" alt="Avatar of Linux-Scratcher"> Linux-Scratcher
			</a><br/>
			Linux-Scratcher
		</td>
		<td>@socialteams </td>
