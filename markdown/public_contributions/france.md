...
The `public contributions` by users in France on `2025/7/30 8:35 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Linux-Scratcher">
				<img src="https://avatars.githubusercontent.com/u/122288570?s=72&u=f72029b122c81f3912ad38fe5dfd29fe2fddc486&v=4" width="24" alt="Avatar of Linux-Scratcher"> Linux-Scratcher
			</a><br/>
			✟Gianni✞
		</td>
		<td>@socialteams </td>
