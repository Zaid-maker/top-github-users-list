...
The `public contributions` by users in France on `2023/1/27 2:17 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `975 users`  in France. You need at least `136 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@framasoft </td>
		<td><a href="https://twitter.com/tcitworld">tcitworld</a></td>
		<td>Nantes, France</td>
		<td>1226</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>@up-group </td>
		<td><a href="https://twitter.com/nxm_mastodon">nxm_mastodon</a></td>
		<td>Lyon, France</td>
		<td>49</td>
	</tr>
	<tr>
