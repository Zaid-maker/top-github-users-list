...
The `public contributions` by users in Vietnam on `2023/12/19 5:14 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
