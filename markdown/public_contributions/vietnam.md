...
The `public contributions` by users in Vietnam on `2023/12/25 11:15 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
