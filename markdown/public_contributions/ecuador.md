...
The `public contributions` by users in Ecuador on `2023/2/14 8:18 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
