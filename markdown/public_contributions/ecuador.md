...
The `public contributions` by users in Ecuador on `2024/4/15 10:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
