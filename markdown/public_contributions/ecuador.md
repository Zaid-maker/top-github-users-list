...
The `public contributions` by users in Ecuador on `2024/6/17 7:15 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
