...
The `public contributions` by users in Ecuador on `2023/1/21 8:17 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
