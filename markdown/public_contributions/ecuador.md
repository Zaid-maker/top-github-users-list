...
The `public contributions` by users in Ecuador on `2023/3/16 10:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
