...
The `public contributions` by users in Ecuador on `2023/1/9 8:18 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
