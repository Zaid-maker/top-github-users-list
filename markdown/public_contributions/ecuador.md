...
The `public contributions` by users in Ecuador on `2022/12/26 3:17 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
