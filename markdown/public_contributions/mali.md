...
The `public contributions` by users in Mali on `2024/11/14 7:16 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/devdiagui">
				<img src="https://avatars.githubusercontent.com/u/187724865?s=72&v=4" width="24" alt="Avatar of devdiagui"> devdiagui
			</a><br/>
			Mahatma Diagui
		</td>
		<td>No Company</td>
