...
The `public contributions` by users in Colombia on `2022/12/25 6:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
