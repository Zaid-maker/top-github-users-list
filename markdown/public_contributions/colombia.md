...
The `public contributions` by users in Colombia on `2023/12/15 10:44 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
