...
The `public contributions` by users in Colombia on `2023/5/13 11:12 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
