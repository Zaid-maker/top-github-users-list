...
The `public contributions` by users in Sweden on `2022/12/31 9:17 AM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `423 users`  in Sweden. You need at least `132 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/a7ul">
				<img src="https://avatars.githubusercontent.com/u/4029423?s=72&v=4" width="24" alt="Avatar of a7ul"> a7ul
			</a><br/>
			Atul R
		</td>
		<td>@anyfin  </td>
	...
	<tr>
		...
		<td>Zi Ran </td>
		<td><a href="https://twitter.com/oferlund">oferlund</a></td>
		<td>Sweden</td>
		<td>22</td>
	</tr>
	<tr>
