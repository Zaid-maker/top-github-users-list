...
The `public contributions` by users in Benin on `2024/4/13 4:17 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		<td>465</td>
		<td>
			<a href="https://github.com/angelita50lakinsim">
				<img src="https://avatars.githubusercontent.com/u/166654388?s=72&v=4" width="24" alt="Avatar of angelita50lakinsim"> angelita50lakinsim
			</a><br/>
			Jose Carter
		</td>
		<td> Patton-jones </td>
