...
The `public contributions` by users in Benin on `2024/5/18 9:14 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/HectorLanmasso2">
				<img src="https://avatars.githubusercontent.com/u/170178450?s=72&v=4" width="24" alt="Avatar of HectorLanmasso2"> HectorLanmasso2
			</a><br/>
			Hector Lanmasso 
		</td>
		<td>No Company</td>
