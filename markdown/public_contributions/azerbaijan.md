...
The `public contributions` by users in Azerbaijan on `2023/2/19 2:24 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
