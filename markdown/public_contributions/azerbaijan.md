...
The `public contributions` by users in Azerbaijan on `2023/12/26 12:45 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
