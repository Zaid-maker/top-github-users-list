...
The `public contributions` by users in Azerbaijan on `2025/4/8 11:20 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
