...
The `public contributions` by users in Azerbaijan on `2023/5/18 12:19 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
