...
The `public contributions` by users in Azerbaijan on `2024/4/7 5:14 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
