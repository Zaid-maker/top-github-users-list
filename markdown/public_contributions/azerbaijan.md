...
The `public contributions` by users in Azerbaijan on `2023/5/24 10:15 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
