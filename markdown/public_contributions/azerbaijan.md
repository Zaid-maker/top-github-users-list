...
The `public contributions` by users in Azerbaijan on `2025/4/20 1:30 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
