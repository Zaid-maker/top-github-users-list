...
The `public contributions` by users in Azerbaijan on `2024/9/12 3:20 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
