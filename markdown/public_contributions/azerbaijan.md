...
The `public contributions` by users in Azerbaijan on `2022/12/24 7:12 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
