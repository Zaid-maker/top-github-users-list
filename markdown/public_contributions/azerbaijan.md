...
The `public contributions` by users in Azerbaijan on `2023/12/31 6:17 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
