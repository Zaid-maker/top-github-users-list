...
The `public contributions` by users in Azerbaijan on `2024/9/30 1:30 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
