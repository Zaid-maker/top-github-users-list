...
The `public contributions` by users in Taiwan on `2022/12/25 5:15 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
