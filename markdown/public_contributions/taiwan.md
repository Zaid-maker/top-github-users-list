...
The `public contributions` by users in Taiwan on `2023/2/13 10:16 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
