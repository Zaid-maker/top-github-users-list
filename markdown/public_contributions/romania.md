...
The `public contributions` by users in Romania on `2024/6/8 9:16 PM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/georgecatalin">
				<img src="https://avatars.githubusercontent.com/u/45753986?s=72&v=4" width="24" alt="Avatar of georgecatalin"> georgecatalin
			</a><br/>
			George Calin
		</td>
		<td>No Company</td>
