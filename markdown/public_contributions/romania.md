...
The `public contributions` by users in Romania on `2024/5/16 8:17 PM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
...
<table>
	...
	<tr>
		...
		<td>Pisoft </td>
		<td><a href="https://twitter.com/iuliarpuiu">iuliarpuiu</a></td>
		<td>Romania</td>
		<td>59</td>
	</tr>
	<tr>
