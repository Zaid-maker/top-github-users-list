...
The `public contributions` by users in Switzerland on `2024/10/23 6:26 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `874 users`  in Switzerland. You need at least `84 followers` to be on this list.
