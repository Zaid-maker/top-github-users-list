...
The `public contributions` by users in Switzerland on `2024/4/18 7:16 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `891 users`  in Switzerland. You need at least `77 followers` to be on this list.
