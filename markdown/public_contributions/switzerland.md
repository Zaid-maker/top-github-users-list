...
The `public contributions` by users in Switzerland on `2023/3/13 11:16 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
