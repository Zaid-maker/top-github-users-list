...
The `public contributions` by users in Switzerland on `2024/9/17 10:21 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `877 users`  in Switzerland. You need at least `83 followers` to be on this list.
