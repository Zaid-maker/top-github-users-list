...
The `public contributions` by users in Switzerland on `2024/12/16 8:28 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `869 users`  in Switzerland. You need at least `86 followers` to be on this list.
