...
The `public contributions` by users in Switzerland on `2023/4/6 5:14 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
