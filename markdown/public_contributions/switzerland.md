...
The `public contributions` by users in Switzerland on `2024/4/12 8:20 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `893 users`  in Switzerland. You need at least `77 followers` to be on this list.
