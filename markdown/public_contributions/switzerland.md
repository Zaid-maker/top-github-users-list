...
The `public contributions` by users in Switzerland on `2023/3/25 7:12 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
