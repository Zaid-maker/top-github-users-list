...
The `public contributions` by users in Switzerland on `2025/4/7 6:28 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `857 users`  in Switzerland. You need at least `92 followers` to be on this list.
