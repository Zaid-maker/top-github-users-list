...
The `public contributions` by users in Iran on `2024/12/25 4:25 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
