...
The `public contributions` by users in South Africa on `2023/1/18 2:17 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
