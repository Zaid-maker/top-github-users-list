...
The `public contributions` by users in Saudi Arabia on `2023/4/23 1:15 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
