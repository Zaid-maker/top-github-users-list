...
The `public contributions` by users in Bulgaria on `2023/4/19 9:14 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
