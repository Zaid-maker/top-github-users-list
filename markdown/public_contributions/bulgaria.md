...
The `public contributions` by users in Bulgaria on `2025/6/2 8:24 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
