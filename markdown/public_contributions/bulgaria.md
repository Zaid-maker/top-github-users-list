...
The `public contributions` by users in Bulgaria on `2024/10/18 10:19 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
