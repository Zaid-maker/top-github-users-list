...
The `public contributions` by users in Bulgaria on `2025/6/15 8:24 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
