...
The `public contributions` by users in Bulgaria on `2023/4/2 11:12 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
