...
The `public contributions` by users in Bulgaria on `2023/3/15 2:16 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
