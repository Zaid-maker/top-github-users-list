...
The `public contributions` by users in Bulgaria on `2023/3/27 10:16 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
