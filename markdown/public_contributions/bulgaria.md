...
The `public contributions` by users in Bulgaria on `2023/5/1 11:13 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
