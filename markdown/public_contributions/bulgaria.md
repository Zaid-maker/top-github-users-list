...
The `public contributions` by users in Bulgaria on `2025/3/9 8:20 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
