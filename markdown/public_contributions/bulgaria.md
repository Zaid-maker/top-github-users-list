...
The `public contributions` by users in Bulgaria on `2025/8/29 6:28 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
