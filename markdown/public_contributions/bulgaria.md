...
The `public contributions` by users in Bulgaria on `2024/8/14 8:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
