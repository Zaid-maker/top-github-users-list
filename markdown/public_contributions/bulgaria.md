...
The `public contributions` by users in Bulgaria on `2025/2/7 6:24 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
