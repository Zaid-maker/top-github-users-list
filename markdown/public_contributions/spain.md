...
The `public contributions` by users in Spain on `2023/3/13 7:15 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
