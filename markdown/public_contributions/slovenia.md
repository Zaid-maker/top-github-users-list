...
The `public contributions` by users in Slovenia on `2025/4/25 3:43 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
...
<table>
	...
	<tr>
		<td>455</td>
		<td>
			<a href="https://github.com/mstumberger">
				<img src="https://avatars.githubusercontent.com/u/17837422?s=72&v=4" width="24" alt="Avatar of mstumberger"> mstumberger
			</a><br/>
			Marko Štumberger
		</td>
		<td>No Company</td>
