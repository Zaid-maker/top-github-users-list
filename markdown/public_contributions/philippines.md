...
The `public contributions` by users in Philippines on `2023/5/16 10:15 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
