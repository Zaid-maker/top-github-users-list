...
The `public contributions` by users in Philippines on `2023/4/23 5:14 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
