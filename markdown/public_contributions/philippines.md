...
The `public contributions` by users in Philippines on `2023/1/17 10:16 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
