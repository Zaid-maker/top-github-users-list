...
The `public contributions` by users in Israel on `2024/4/4 1:52 AM UTC`. This list contains users from `Israel` and cities `Jerusalem` `Tel-aviv` `Haifa` `Lod` `Be'er-sheva` `Ashkelon` `Bat-yam` `Netanya`.
...
<table>
	...
	<tr>
		...
		<td>@provengo, Harvard Iqss, Bgu<br/></td>
