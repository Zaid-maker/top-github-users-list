...
The `public contributions` by users in Croatia on `2024/3/16 4:16 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
...
<table>
	...
	<tr>
		...
		<td>@infinum </td>
		<td><a href="https://twitter.com/nikolamajcen">nikolamajcen</a></td>
		<td>Croatia</td>
		<td>117</td>
	</tr>
	<tr>
