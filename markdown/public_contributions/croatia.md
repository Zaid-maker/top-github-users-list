...
The `public contributions` by users in Croatia on `2025/8/17 4:25 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `964 users`  in Croatia. You need at least `11 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>657</td>
		<td>
			<a href="https://github.com/matija">
				<img src="https://avatars.githubusercontent.com/u/8150171?s=72&u=02d2421ace8a33494e070071c219999e04af997f&v=4" width="24" alt="Avatar of matija"> matija
			</a><br/>
			Matija Munjaković
		</td>
		<td>@kodius @getunblock </td>
		<td>No Twitter Username</td>
		<td>Croatia</td>
		<td>2</td>
	</tr>
