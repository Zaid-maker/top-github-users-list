...
The `public contributions` by users in Croatia on `2025/2/1 9:20 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
...
<table>
	...
	<tr>
		<td>666</td>
		<td>
			<a href="https://github.com/pavikaa">
				<img src="https://avatars.githubusercontent.com/u/20866769?s=72&v=4" width="24" alt="Avatar of pavikaa"> pavikaa
			</a><br/>
			Marko Pavičić
		</td>
		<td>@barrage  </td>
