...
The `public contributions` by users in Kazakhstan on `2024/4/16 11:14 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		<td>130</td>
		<td>
			<a href="https://github.com/xitowzys">
				<img src="https://avatars.githubusercontent.com/u/73164354?s=72&v=4" width="24" alt="Avatar of xitowzys"> xitowzys
			</a><br/>
			Kalinka George
		</td>
		<td>No Company</td>
