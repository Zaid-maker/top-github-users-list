...
The `public contributions` by users in Kazakhstan on `2024/6/7 5:17 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		<td>496</td>
		<td>
			<a href="https://github.com/zigmund">
				<img src="https://avatars.githubusercontent.com/u/1713091?s=72&u=5fdf56bfaf7e70dbe077dd2aa0683110276db4a6&v=4" width="24" alt="Avatar of zigmund"> zigmund
			</a><br/>
			Oleg Morozov
		</td>
		<td>Kolesa Group </td>
