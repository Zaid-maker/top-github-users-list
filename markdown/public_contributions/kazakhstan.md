...
The `public contributions` by users in Kazakhstan on `2025/6/23 2:22 PM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ssuleimenovv">
				<img src="https://avatars.githubusercontent.com/u/123289263?s=72&u=d895181327c0b79240da3b7ed161f0bfd86d5fce&v=4" width="24" alt="Avatar of ssuleimenovv"> ssuleimenovv
			</a><br/>
			Suleimenov Ayan
		</td>
		<td>No Company</td>
