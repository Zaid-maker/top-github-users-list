...
The `public contributions` by users in Tanzania on `2023/1/12 10:15 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
