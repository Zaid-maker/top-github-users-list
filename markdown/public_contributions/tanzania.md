...
The `public contributions` by users in Tanzania on `2023/4/12 1:18 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
