...
The `public contributions` by users in Malaysia on `2025/7/19 3:28 AM UTC`. This list contains users from `Malaysia` and cities `Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `975 users`  in Malaysia. You need at least `21 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>86</td>
		<td>
			<a href="https://github.com/Jeffrey04">
				<img src="https://avatars.githubusercontent.com/u/46977?s=72&v=4" width="24" alt="Avatar of Jeffrey04"> Jeffrey04
			</a><br/>
			Choon-Siang Lai
		</td>
		<td>Dahu Technology </td>
		<td>No Twitter Username</td>
