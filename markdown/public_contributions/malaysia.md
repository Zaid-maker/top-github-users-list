...
The `public contributions` by users in Malaysia on `2024/10/9 7:20 AM UTC`. This list contains users from `Malaysia` and cities `Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `978 users`  in Malaysia. You need at least `19 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bashketchum02">
				<img src="https://avatars.githubusercontent.com/u/46514454?s=72&u=07e7b5786c60221fd40fba31fc551c4a7a7d6b64&v=4" width="24" alt="Avatar of bashketchum02"> bashketchum02
			</a><br/>
			bashketchum02
		</td>
		<td>@moneylion </td>
	...
	<tr>
		...
		<td>Tajdid Corporation Sdn. Bhd.<br/></td>
