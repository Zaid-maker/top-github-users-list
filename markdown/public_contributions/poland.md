...
The `public contributions` by users in Poland on `2024/7/30 11:20 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
...
<table>
	...
	<tr>
		<td>655</td>
		<td>
			<a href="https://github.com/SoftwarePassioner">
		...
		<td>Developer For Ai/mobile/web App<br/>&<br/>Blockchain<br/>&<br/>Full-stack<br/>Web<br/></td>
		<td>No Twitter Username</td>
		<td>Jerzego Michałowicza 76, Warszawa, Poland</td>
		<td>22</td>
	</tr>
	<tr>
		<td>656</td>
