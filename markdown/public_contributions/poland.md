...
The `public contributions` by users in Poland on `2023/4/17 10:17 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
