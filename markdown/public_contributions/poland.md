...
The `public contributions` by users in Poland on `2023/5/10 2:17 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
