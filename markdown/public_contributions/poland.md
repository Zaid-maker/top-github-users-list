...
The `public contributions` by users in Poland on `2023/5/4 7:15 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
