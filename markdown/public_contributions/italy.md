...
The `public contributions` by users in Italy on `2024/12/1 4:23 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `960 users`  in Italy. You need at least `80 followers` to be on this list.
