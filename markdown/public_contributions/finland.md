...
The `public contributions` by users in Finland on `2024/12/13 1:09 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
