...
The `public contributions` by users in Finland on `2025/8/5 1:47 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
