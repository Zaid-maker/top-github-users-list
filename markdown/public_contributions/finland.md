...
The `public contributions` by users in Finland on `2023/1/15 1:21 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
