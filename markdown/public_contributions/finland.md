...
The `public contributions` by users in Finland on `2023/2/8 1:25 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
