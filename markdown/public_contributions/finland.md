...
The `public contributions` by users in Finland on `2024/6/18 12:51 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
