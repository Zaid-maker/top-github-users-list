...
The `public contributions` by users in Finland on `2023/4/15 2:07 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
