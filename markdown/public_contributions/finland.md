...
The `public contributions` by users in Finland on `2023/3/22 2:15 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
