...
The `public contributions` by users in Finland on `2023/3/10 4:19 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
