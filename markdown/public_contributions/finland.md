...
The `public contributions` by users in Finland on `2024/10/19 11:20 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
