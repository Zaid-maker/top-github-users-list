...
The `public contributions` by users in Finland on `2025/6/22 5:20 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
