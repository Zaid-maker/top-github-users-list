...
The `public contributions` by users in Finland on `2024/2/23 12:45 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
