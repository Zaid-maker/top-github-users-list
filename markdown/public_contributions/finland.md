...
The `public contributions` by users in Finland on `2023/4/26 5:15 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
