...
The `public contributions` by users in Germany on `2023/1/9 4:19 PM UTC`. This list contains users from `Germany` and cities `Berlin` `Munich` `Hamburg` `Cologne` `Hamburg` `Düsseldorf` `Stuttgart` `Dresden`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `69 users`  in Germany. You need at least `1790 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/anathlab">
				<img src="https://avatars.githubusercontent.com/u/45717852?s=72&v=4" width="24" alt="Avatar of anathlab"> anathlab
			</a><br/>
			Anath
		</td>
		<td>Pjait </td>
