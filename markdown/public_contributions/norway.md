...
The `public contributions` by users in Norway on `2023/12/17 11:17 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
...
<table>
	...
	<tr>
		<td>322</td>
		<td>
			<a href="https://github.com/osaether">
				<img src="https://avatars.githubusercontent.com/u/16463587?s=72&v=4" width="24" alt="Avatar of osaether"> osaether
			</a><br/>
			Ole Sæther
		</td>
		<td>@nordicsemiconductor </td>
		<td><a href="https://twitter.com/osaether">osaether</a></td>
		<td>Trondheim, Norway</td>
		<td>173</td>
	</tr>
	<tr>
