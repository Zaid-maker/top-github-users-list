...
The `public contributions` by users in Norway on `2024/5/27 9:20 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `943 users`  in Norway. You need at least `38 followers` to be on this list.
