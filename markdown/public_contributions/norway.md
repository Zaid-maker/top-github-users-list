...
The `public contributions` by users in Norway on `2025/3/24 11:22 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `922 users`  in Norway. You need at least `44 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/sandviklee">
				<img src="https://avatars.githubusercontent.com/u/74411800?s=72&u=5ee186f23ac486bbcae7133e3b5c42c6078e5932&v=4" width="24" alt="Avatar of sandviklee"> sandviklee
			</a><br/>
			Simon Sandvik Lee
		</td>
		<td>@kateter-platform, @orbitntnu, @cogitontnu </td>
	...
	<tr>
		...
		<td>Ntnu & Csiro's Data61<br/><br/></td>
		<td>No Twitter Username</td>
		<td>Trondheim 🇳🇴 / Sydney 🇦🇺</td>
		<td>194</td>
	</tr>
	<tr>
		<td>274</td>
