...
The `public contributions` by users in Norway on `2025/6/12 7:24 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `681 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `915 users`  in Norway. You need at least `46 followers` to be on this list.
