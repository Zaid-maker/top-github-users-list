...
The `public contributions` by users in Norway on `2024/10/16 2:26 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `666 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `934 users`  in Norway. You need at least `41 followers` to be on this list.
