...
The `public contributions` by users in Norway on `2025/2/11 1:03 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `926 users`  in Norway. You need at least `43 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Deepinsight </td>
		<td><a href="https://twitter.com/adamcik">adamcik</a></td>
		<td>Oslo, Norway</td>
		<td>145</td>
	</tr>
	<tr>
