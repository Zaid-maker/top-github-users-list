...
The `public contributions` by users in Norway on `2024/12/27 6:25 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `928 users`  in Norway. You need at least `42 followers` to be on this list.
