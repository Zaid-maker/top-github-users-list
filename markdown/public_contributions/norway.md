...
The `public contributions` by users in Norway on `2025/5/6 8:29 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `668 cities` can be found [here](https://github.com/Zaid-maker/top-github-users-list).

There are `918 users`  in Norway. You need at least `45 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mjovanc">
				<img src="https://avatars.githubusercontent.com/u/33717111?s=72&u=b801089c1a4a96f9ac552fe31d3b7d3028ee26e2&v=4" width="24" alt="Avatar of mjovanc"> mjovanc
			</a><br/>
			Marcus Cvjeticanin
		</td>
		<td>0x02d5 </td>
